...
class QiNiuImageService extends QiNiuService
{
    ...
    public function getImageDownloadUrl($url, $options = [])
    {
        ...
        // 获取防盗链配置
        $imageUrlStatus = ConfigHelper::fresnsConfigByItemKey(QiNiuConfig::IMAGE_URL_STATUS);
        $imageUrlExpire = ConfigHelper::fresnsConfigByItemKey(QiNiuConfig::IMAGE_URL_EXPIRE);

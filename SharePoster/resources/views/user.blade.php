...
@section('content')
    <form action="{{ route('share-poster.admin.update') }}" method="post" enctype="multipart/form-data">
        ...
        {{-- avatar --}}
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.avatar_size') }}:</label>
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.avatar_circle') }}:</label>
            <div class="col-lg-4 pt-2">
                <div class="form-check form-check-inline">
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.avatar_x_position') }}:</label>
        ...
        <div class="row mb-3">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.avatar_y_position') }}:</label>
        ...
        {{-- nickname --}}
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.nickname_color') }}:</label>
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.nickname_font_size') }}:</label>
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.nickname_x_center') }}:</label>
            <div class="col-lg-4 pt-2">
                <div class="form-check form-check-inline">
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.nickname_x_position') }}:</label>
            <div class="col-lg-4"><input type="number" class="form-control" name="nickname_x_position" value="{{ $config['nickname_x_position'] ?? '' }}"></div>
            <div class="col-lg-5 form-text pt-1"><i class="bi bi-info-circle"></i> x - abscissa</div>
        </div>
        <div class="row mb-3">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.nickname_y_position') }}:</label>
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.bio_font_size') }}:</label>
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.bio_x_position') }}:</label>
            <div class="col-lg-4"><input type="number" class="form-control" name="bio_x_position" value="{{ $config['bio_x_position'] ?? '' }}"></div>
            <div class="col-lg-5 form-text pt-1"><i class="bi bi-info-circle"></i> x - abscissa</div>
        </div>
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.bio_y_position') }}:</label>
            <div class="col-lg-4"><input type="number" class="form-control" name="bio_y_position" value="{{ $config['bio_y_position'] ?? '' }}"></div>
            <div class="col-lg-5 form-text pt-1"><i class="bi bi-info-circle"></i> y - ordinate</div>
        </div>
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.bio_max_width') }}:</label>
        ...
        <div class="row mb-2">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.bio_max_lines') }}:</label>
        ...
        <div class="row mb-3">
            <label class="col-lg-3 col-form-label text-lg-end">{{ __('SharePoster::fresns.bio_line_spacing') }}:</label>

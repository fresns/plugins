    ...
    <form action="{{ route('file-storage.admin.update') }}" method="post">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-5">
                <select class="form-select" name="driver">
                    <option value="local" {{ $videoDriver == 'local' ? 'selected' : '' }}>Local</option>
                    <option value="ftp" {{ $videoDriver == 'ftp' ? 'selected' : '' }}>FTP</option>
                    <option value="sftp" {{ $videoDriver == 'sftp' ? 'selected' : '' }}>SFTP</option>
                </select>
            </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-5 pt-1">
                <a class="btn btn-outline-secondary btn-sm px-4 me-2" href="{{ route('panel.storage.video.index') }}" target="_blank" role="button">{{ __('FsLang::panel.button_config') }}</a>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-5">
                <textarea class="form-control" id="privateKey" name="privateKey" rows="5">{{ $videoPrivateKey }}</textarea>
            </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-5">
                <input type="text" class="form-control" id="passphrase" name="passphrase" value="{{ $videoPassphrase }}">
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-5">
                <input type="text" class="form-control" id="hostFingerprint" name="hostFingerprint" value="{{ $videoHostFingerprint }}">
            </div>

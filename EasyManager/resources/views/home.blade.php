...
@section('content')
    <div class="mx-0 p-3 p-lg-5 pb-0">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-3 mb-5 pe-4">
                <div class="position-relative bg-light rounded shadow border py-5">
                    <div class="position-absolute top-0 start-0 mt-3 ms-3 fs-7">{{ __('EasyManager::fresns.geotag') }}</div>
                    <div class="text-center fs-1 fw-bolder">{{ $overview['geotagCount'] }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-3 mb-5 pe-4">
                <div class="position-relative bg-light rounded shadow border py-5">
                    <div class="position-absolute top-0 start-0 mt-3 ms-3 fs-7">{{ __('EasyManager::fresns.post') }}: General Digest</div>
                    <div class="text-center fs-1 fw-bolder">{{ $overview['postDigest1Count'] }}</div>
                </div>
            </div>
            <div class="col-3 mb-5 pe-4">
                <div class="position-relative bg-light rounded shadow border py-5">
                    <div class="position-absolute top-0 start-0 mt-3 ms-3 fs-7">{{ __('EasyManager::fresns.post') }}: Premium Digest</div>
        ...
        <div class="row">
            ...
            <div class="col-3 mb-5 pe-4">
                <div class="position-relative bg-light rounded shadow border py-5">
                    <div class="position-absolute top-0 start-0 mt-3 ms-3 fs-7">{{ __('EasyManager::fresns.comment') }}: General Digest</div>
                    <div class="text-center fs-1 fw-bolder">{{ $overview['commentDigest1Count'] }}</div>
                </div>
            </div>
            <div class="col-3 mb-5 pe-4">
                <div class="position-relative bg-light rounded shadow border py-5">
                    <div class="position-absolute top-0 start-0 mt-3 ms-3 fs-7">{{ __('EasyManager::fresns.comment') }}: Premium Digest</div>

...
(function () {
    ...
    var t = function (e, n, i) {
        'string' == typeof e
            ? (2 == arguments.length && (i = n), t.modules[e] || ((t.payloads[e] = i), (t.modules[e] = null)))
            : t.original
    ...
    var n = function (e, t, n) {
        ...
        i = function (e, t) {
            var o = n('', e, t);
            return null == o && i.original ? i.original.apply(this, arguments) : o;
        },
        o = function (e, t) {
            if (-1 !== t.indexOf('!')) {
                var n = t.split('!');
        ...
        r = function (e, i) {
            ...
            if (!r) {
                if ('function' == typeof (r = t.payloads[i])) {
                    ...
                    (s = l || a.exports), (t.modules[i] = s), delete t.payloads[i];
                }
                r = t.modules[i] = s || r;
            }
            return r;
    ...
    !(function (n) {
        var o = e;
        n && (e[n] || (e[n] = {}), (o = e[n])),
            (o.define && o.define.packaged) || ((t.original = o.define), (o.define = t), (o.define.packaged = !0)),
            (o.require && o.require.packaged) || ((i.original = o.require), (o.require = i), (o.require.packaged = !0));
    })('ace');
})(),
    ...
    ace.define('ace/lib/dom', ['require', 'exports', 'module', 'ace/lib/useragent'], function (e, t, n) {
        ...
        function o(e, n, o) {
            if ('undefined' != typeof document) {
                if (a)
                    if (o) i();
                    else if (!1 === o) return a.push([e, n]);
                if (!s) {
                    var r = o;
                    (o && o.getRootNode && (r = o.getRootNode()) && r != o) || (r = document);
        ...
        if (
            ...
            (t.HI_DPI = !r.isWin || ('undefined' != typeof window && window.devicePixelRatio >= 1.5)),
            r.isChromeOS && (t.HI_DPI = !1),
            'undefined' != typeof document)
        ) {
            var l = document.createElement('div');
            t.HI_DPI && void 0 !== l.style.transform && (t.HAS_CSS_TRANSFORMS = !0),
                !r.isEdge && void 0 !== l.style.animationName && (t.HAS_CSS_ANIMATION = !0),
                (l = null);
        }
            ...
            (t.loadScript = function (e, t) {
                ...
                (o.src = e),
                    ...
                    (o.onload = o.onreadystatechange =
                        function (e, n) {
                            (!n && o.readyState && 'loaded' != o.readyState && 'complete' != o.readyState) ||
        ...
        (i._emit = i._dispatchEvent =
            ...
            (i.on = i.addEventListener =
                function (e, t, n) {
                    ...
                    return (
                        i || (i = this._eventRegistry[e] = []), -1 == i.indexOf(t) && i[n ? 'unshift' : 'push'](t), t
                    );
                }),
            (i.off =
                i.removeListener =
            ...
            (t.setLoader = function (e) {
                ...
                (t.loadModule = function (n, i) {
                    ...
                    var a = function (e) {
                        ...
                        if (
                            (t.$loading[n] || (t.$loading[n] = []), t.$loading[n].push(i), !(t.$loading[n].length > 1))
                        ) {
                            var r = function () {
                                l(n, function (e, i) {
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            function i(t) {
                if (s && s.document) {
                    r.set('packaged', t || e.packaged || n.packaged || (s.define && define.packaged));
                    var i = {},
                        a = '',
                        l = document.currentScript || document._currentScript,
                        c = (l && l.ownerDocument) || document;
                    l && l.src && (a = l.src.split(/[?#]/)[0].split('/').slice(0, -1).join('/') || '');
                    for (var h = c.getElementsByTagName('script'), u = 0; u < h.length; u++) {
                        var d = h[u],
                            g = d.src || d.getAttribute('src');
                        if (g) {
                            for (var p = d.attributes, f = 0, m = p.length; f < m; f++) {
                                var v = p[f];
                                0 === v.name.indexOf('data-ace-') && (i[o(v.name.replace(/^data-ace-/, ''))] = v.value);
                            }
                            var w = g.match(/^(.*)\/ace([\-.]\w+)?\.js(\?|$)/);
                            w && (a = w[1]);
                        }
                    }
                    for (var y in (a && ((i.base = i.base || a), (i.packaged = !0)),
                    (i.basePath = i.base),
            ...
            n.exports = function (t) {
                (r.init = i), (t.require = e), 'function' == typeof define && (t.define = define);
            };
        }
    ),
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            function r(e, t, n) {
                ...
                if (!c.isMac && h) {
                    if (
                        (t.getModifierState && (t.getModifierState('OS') || t.getModifierState('Win')) && (i |= 8),
                        h.altGr)
                    ) {
                        if (3 == (3 & i)) return;
                        h.altGr = 0;
                    ...
                    if (18 === n || 17 === n) {
                        ...
                        if (17 === n && 1 === o) 1 == h[n] && (u = t.timeStamp);
                        else if (18 === n && 3 === i && 2 === o) {
                            t.timeStamp - u < 50 && (h.altGr = !0);
                        }
                    }
                }
                if (
                    (n in l.MODIFIER_KEYS && (n = -1), !i && 13 === n) &&
                    3 === (o = 'location' in t ? t.location : t.keyLocation) &&
                ...
                return !!(i || n in l.FUNCTION_KEYS || n in l.PRINTABLE_KEYS) && e(t, i, n);
            }
            function s() {
            ...
            o.prototype.destroy = function () {
                g(this.elem, this.type, this.callback), (this.elem = this.type = this.callback = void 0);
            };
            var d = (t.addListener = function (e, t, n, r) {
                    e.addEventListener(t, n, i()), r && r.$toDestroy.push(new o(e, t, n));
                }),
                g = (t.removeListener = function (e, t, n) {
            ...
            (t.stopEvent = function (e) {
                ...
                (t.getButton = function (e) {
                    return 'dblclick' == e.type
                        ? 0
                        : 'contextmenu' == e.type || (c.isMac && e.ctrlKey && !e.altKey && !e.shiftKey)
                        ? 2
                        : e.button;
                }),
                (t.capture = function (e, t, n) {
                    function i(e) {
                        t && t(e), n && n(e), g(o, 'mousemove', t), g(o, 'mouseup', i), g(o, 'dragstart', i);
                    }
                    var o = (e && e.ownerDocument) || document;
                    return d(o, 'mousemove', t), d(o, 'mouseup', i), d(o, 'dragstart', i), i;
                }),
                ...
                (t.addMultiMouseDownListener = function (e, n, i, o, r) {
                    function s(e) {
                        if ((0 !== t.getButton(e) ? (u = 0) : e.detail > 1 ? ++u > 4 && (u = 1) : (u = 1), c.isIE)) {
                        ...
                        else if (u > 1) return i[o](g[u], e);
                    }
                    var a,
                        l,
                        h,
                        u = 0,
                        g = { 2: 'dblclick', 3: 'tripleclick', 4: 'quadclick' };
                    Array.isArray(e) || (e = [e]),
                        e.forEach(function (e) {
                            d(e, 'mousedown', s, r);
                        });
            ...
            if (
                ...
                t.nextTick = function (e, n) {
                    ...
                    var i = 'zero-timeout-message-' + f++,
                        o = function (r) {
                            r.data == i && (t.stopPropagation(r), g(n, 'message', o), e());
                        };
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            (t.TextInput = function (e, t) {
                function n(e) {
                    if (
                        ((!b || !b.parentNode) && document.removeEventListener('selectionchange', n),
                        !S && b.selectionStart === b.selectionEnd)
                    ) {
                        var i = b.selectionStart - R,
                            o = T - R;
                        i > 0 ? (i = Math.max(i - o, 1)) : 0 === i && o && (i = -1);
                        for (var r = Math.abs(i), s = i > 0 ? g.right : g.left, a = 0; a < r; a++)
                            t.onCommandKey({}, 0, s);
                    }
                }
                function w() {
                ...
                var b = s.createElement('textarea');
                ...
                (this.setAriaOptions = function (e) {
                    e.activeDescendant
                        ? (b.setAttribute('aria-haspopup', 'true'),
                          b.setAttribute('aria-autocomplete', e.inline ? 'both' : 'list'),
                    ...
                    (this.setAriaLabel = function () {
                        if (t.session && t.renderer.enableKeyboardAccessibility) {
                            ...
                            b.setAttribute('aria-roledescription', o('editor')),
                                b.setAttribute('aria-label', o('Cursor at row $0', [e + 1]));
                        } else b.removeAttribute('aria-roledescription'), b.removeAttribute('aria-label');
                    }),
                    ...
                    i.addListener(
                        ...
                        'blur',
                        function (e) {
                            L || (t.onBlur(e), (_ = !1), v && !f && document.removeEventListener('selectionchange', n));
                        },
                        t
                    ),
                    i.addListener(
                        ...
                        function (e) {
                            if (!L) {
                                ...
                                t.onFocus(e),
                                    ...
                                    v && !f && document.addEventListener('selectionchange', n);
                            }
                        },
                        t
                    ),
                    (this.$focusScroll = !1),
                    (this.focus = function () {
                        if ((this.setAriaLabel(), A || u || 'browser' == this.$focusScroll))
                        ...
                        b.focus({ preventScroll: !0 }),
                            ...
                            setTimeout(function () {
                                (b.style.position = ''), '0px' == b.style.top && (b.style.top = e);
                            }, 0);
                    }),
                    (this.blur = function () {
                        b.blur();
                ...
                var I = f
                    ? function (e) {
                          if (_ && (!$ || e) && !x) {
                              ...
                              (4 != R || T != i) && b.setSelectionRange(4, i), (R = 4), (T = i);
                          }
                      }
                    : function () {
                          if (!S && !x && (_ || D)) {
                              ...
                              if (t.session) {
                                  ...
                                  if (
                                      ...
                                      (e = r.start.row < s - 1 ? 0 : e), (n += a.length + 1), (i = a + '\n' + i);
                                  } else if (r.end.row != s) {
                                      var l = t.session.getLine(s + 1);
                                      (n = r.end.row > s + 1 ? l.length : n), (n += i.length + 1), (i = i + '\n' + l);
                                  } else v && s > 0 && ((i = '\n' + i), (n += 1), (e += 1));
                                  i.length > d &&
                                      (e < d && n < d
                                          ? (i = i.slice(0, d))
                              ...
                              if (
                                  ...
                                  D && ((R = b.selectionStart), (T = b.selectionEnd)),
                ...
                var D = !1,
                    F = function (e, n) {
                        if ((D && (D = !1), C)) return I(), e && t.onPaste(e), (C = !1), '';
                        for (
                        ...
                        for (
                            l = l.slice(u), u = 1;
                            a > 0 && M.length - u > R - 1 && M[M.length - u] == e[e.length - u];

                        )
                            u++, a--;
                        (c -= u - 1), (h -= u - 1);
                        var d = l.length - u + 1;
                        if ((d < 0 && ((s = -d), (d = 0)), (l = l.slice(0, d)), !(n || l || c || s || a || h)))
                            return '';
                        x = !0;
                        var g = !1;
                        return (
                            ...
                            (l && !s && !a && !c && !h) || k
                                ? t.onTextInput(l)
                                : t.onTextInput(l, { extendLeft: s, extendRight: a, restoreStart: c, restoreEnd: h }),
                            (x = !1),
                            (M = e),
                            (R = i),
                            (T = o),
                    ...
                    W = function (e) {
                        ...
                        var n = b.value,
                            i = F(n, !0);
                        (n.length > 500 || m.test(i) || (v && R < 1 && R == T)) && I();
                    },
                    N = function (e, t, n) {
                    ...
                    z = function (e) {
                        ...
                        l.pasteCancelled() ||
                            ('string' == typeof n
                                ? (n && t.onPaste(n, e), r.isIE && setTimeout(I), i.preventDefault(e))
                                : ((b.value = ''), (C = !0)));
                    };
                        ...
                        function (e) {
                            S ||
                                ($
                                    ...
                                    ? (t.selectAll(), I())
                                    : v && b.selectionStart != R && I());
                        },
                        t
                    ),
                    i.addListener(b, 'input', W, t),
                    i.addListener(b, 'cut', B, t),
                    i.addListener(b, 'copy', P, t),
                    i.addListener(b, 'paste', z, t),
                ...
                var V = function () {
                        if (S && t.onCompositionUpdate && !t.$readOnly) {
                            if (k) return w();
                            if (S.useTextareaForIME) t.onCompositionUpdate(b.value);
                            else {
                                var e = b.value;
                                F(e),
                                    S.markerRange &&
                                        ...
                                        (S.markerRange.end.column =
                                            S.markerRange.start.column + T - S.selectionStart + E));
                            }
                        }
                    },
                    U = function (e) {
                        t.onCompositionEnd &&
                            !t.$readOnly &&
                            ((S = !1), t.onCompositionEnd(), t.off('mousedown', w), e && W());
                    },
                    G = a.delayedCall(V, 50).schedule.bind(null, null);
                i.addListener(
                    b,
                    'compositionstart',
                    function (e) {
                        if (!S && t.onCompositionStart && !t.$readOnly && ((S = {}), !k)) {
                            ...
                            (n.end.row = n.start.row),
                                ...
                                S.useTextareaForIME
                                    ? ((M = b.value = ''), (R = 0), (T = 0))
                                    : (b.msGetInputContext && (S.context = b.msGetInputContext()),
                                      b.getInputContext && (S.context = b.getInputContext()));
                        }
                    },
                    t
                ),
                    i.addListener(b, 'compositionupdate', V, t),
                    i.addListener(
                        b,
                        'keyup',
                        function (e) {
                    ...
                    (this.moveToMouse = function (e, n) {
                        ...
                        var o = t.container.getBoundingClientRect(),
                            ...
                            u = function (e) {
                                s.translate(b, e.clientX - c - 2, Math.min(e.clientY - l - 2, h));
                            };
                        u(e),
                            'mousedown' == e.type &&
                ...
                i.addListener(b, 'mouseup', j, t),
                    ...
                    i.addListener(t.renderer.scroller, 'contextmenu', j, t),
                    i.addListener(b, 'contextmenu', j, t),
                    f &&
                        (function (e, t, n) {
                            var i = null,
                                o = !1;
                            ...
                            var r = function (e) {
                                if (document.activeElement === n && !(o || S || t.$mouseHandler.isMousePressed || $)) {
                                    ...
                                    if (
                                        (0 == i
                                            ...
                                            : i < R || (i == R && T != R && i == r)
                                            ? (s = g.left)
                                            : r > T && M.slice(0, r).split('\n').length > 2
                                            ? (s = g.down)
                                            : r > T && ' ' == M[r - 1]
                                            ? ((s = g.right), (a = p.option))
                                            : (r > T || (r == T && T != R && i == r)) && (s = g.right),
                                        i !== r && (a |= p.shift),
                                        s)
                                    ) {
    ...
    ace.define('ace/mouse/default_handlers', ['require', 'exports', 'module', 'ace/lib/useragent'], function (e, t, n) {
                ...
                return (
                    (e.prototype.onMouseDown = function (e) {
                        ...
                        var i = this.editor,
                            r = e.getButton();
                        return 0 !== r
                            ? ((i.getSelectionRange().isEmpty() || 1 == r) && i.selection.moveToPosition(n),
                              void (
                                  2 == r && (i.textInput.onContextMenu(e.domEvent), o.isMozilla || e.preventDefault())
                              ))
                    ...
                    (e.prototype.select = function () {
                        ...
                        if (this.$clickSelection) {
                            var o = this.$clickSelection.comparePoint(n);
                            if (-1 == o) e = this.$clickSelection.end;
                            else if (1 == o) e = this.$clickSelection.start;
                            else {
                                var r = i(this.$clickSelection, n);
                    ...
                    (e.prototype.extendSelectionBy = function (e) {
                        var t,
                            n = this.editor,
                            o = n.renderer.screenToTextCoordinates(this.x, this.y),
                            r = n.selection[e](o.row, o.column);
                        if (this.$clickSelection) {
                            var s = this.$clickSelection.comparePoint(r.start),
                                a = this.$clickSelection.comparePoint(r.end);
                            if (-1 == s && a <= 0)
                                (t = this.$clickSelection.end),
                                    (r.end.row == o.row && r.end.column == o.column) || (o = r.start);
                            else if (1 == a && s >= 0)
                                (t = this.$clickSelection.start),
                                    (r.start.row == o.row && r.start.column == o.column) || (o = r.end);
                            else if (-1 == s && 1 == a) (o = r.end), (t = r.start);
                            else {
                                var l = i(this.$clickSelection, o);
                                (o = l.cursor), (t = l.anchor);
                            }
                            n.selection.setSelectionAnchor(t.row, t.column);
                        }
                        n.selection.selectToPosition(o), n.renderer.scrollCursorIntoView();
                    }),
                    ...
                    (e.prototype.focusWait = function () {
                        var e = (function (e, t, n, i) {
                            ...
                            t = Date.now();
                        (e > 0 || t - this.mousedownEvent.time > this.$focusTimeout) &&
                    ...
                    (e.prototype.onTripleClick = function (e) {
                        ...
                        i.isMultiLine() && i.contains(t.row, t.column)
                            ? ((this.$clickSelection = n.selection.getLineRange(i.start.row)),
                              (this.$clickSelection.end = n.selection.getLineRange(i.end.row).end))
                    ...
                    (e.prototype.onMouseWheel = function (e) {
                        if (!e.getAccelKey()) {
                            ...
                            if (
                                ...
                                Math.abs(r) <= 1.5 * Math.abs(n.vx) && Math.abs(s) <= 1.5 * Math.abs(n.vy)
                                    ? ((l = !0), (n.allowed = i))
                                    : (n.allowed = 0);
                            }
                            return (
        ...
        (r.prototype.selectEnd = r.prototype.selectByLinesEnd),
            (r.prototype.selectAllEnd = r.prototype.selectByLinesEnd),
            (r.prototype.selectByWordsEnd = r.prototype.selectByLinesEnd),
            (t.DefaultHandlers = r);
    }),
            ...
            c = (function () {
                ...
                return (
                    ...
                    (e.prototype.updatePopups = function () {
                        ...
                        var r = [];
                        try {
                            for (var s = o(this.popups), a = s.next(); !a.done; a = s.next()) {
                                var l = a.value,
                                    c = !0;
                                try {
                                    for (var h = ((n = void 0), o(r)), u = h.next(); !u.done; u = h.next()) {
                                        var d = u.value;
                    ...
                    (e.prototype.doPopupsOverlap = function (e, t) {
                        ...
                        return n.left < i.right && n.right > i.left && n.top < i.bottom && n.bottom > i.top;
                    }),
                    e
                );
            })(),
            ...
            return (
                ...
                (t.prototype.isOutsideOfText = function (e) {
                    ...
                    if (n.column == i.length) {
                        var o = t.renderer.pixelToScreenCoordinates(e.clientX, e.clientY),
                ...
                (t.prototype.showForRange = function (e, t, n, i) {
                    if (!((i && i != this.lastEvent) || (this.isOpen && document.activeElement == this.getElement()))) {
                        var o = e.renderer;
                        this.isOpen || (h.addPopup(this), this.$registerCloseEvents(), this.setTheme(o.theme)),
                            (this.isOpen = !0),
                        ...
                        var a = o.textToScreenCoordinates(t.start.row, t.start.column),
                            l = e.getCursorPosition(),
                            c = r.clientHeight,
                            u = o.scroller.getBoundingClientRect(),
                            d = !0;
                        this.row > l.row ? (d = !0) : this.row < l.row && (d = !1),
                            a.pageY - c + o.lineHeight < u.top ? (d = !0) : a.pageY + c > u.bottom && (d = !1),
                            d ? (a.pageY += o.lineHeight) : (a.pageY -= c),
        ...
        function (e, t, n) {
            ...
            t.GutterHandler = function (e) {
                function t() {
                    ...
                    if (t == l.session.getLength()) {
                        var o = l.renderer.pixelToScreenCoordinates(0, a.y).row,
                            r = a.$pos;
                        if (o > l.session.documentToScreenRow(r.row, r.column)) return n();
                    }
                    if ((u.showTooltip(t), u.isOpen))
                        if ((l.on('mousewheel', n), e.$tooltipFollowsMouse)) i(a);
                        else {
                            var s = h.$lines.cells[t].element
                                    .querySelector('[class*=ace_icon]')
                                    .getBoundingClientRect(),
                                c = u.getElement().style;
                            (c.left = s.right + 'px'), (c.top = s.bottom + 'px');
                        }
                }
                function n() {
                    o && (o = clearTimeout(o)),
                        u.isOpen && (u.hide(), l._signal('hideGutterTooltip', u), l.off('mousewheel', n));
                }
                function i(e) {
                ...
                var o,
                    a,
                    l = e.editor,
                    h = l.renderer.$gutterLayer,
                    u = new c(l);
                e.editor.setDefaultHandler('guttermousedown', function (t) {
                    if (l.isFocused() && 0 == t.getButton() && 'foldWidgets' != h.getRegion(t)) {
                        var n = t.getDocumentPosition().row,
                            i = l.session.selection;
                        if (t.getShiftKey()) i.selectTo(n, 0);
                        else {
                            if (2 == t.domEvent.detail) return l.selectAll(), t.preventDefault();
                            e.$clickSelection = l.selection.getLineRange(n);
                        }
                    ...
                    e.editor.setDefaultHandler('guttermousemove', function (s) {
                        ...
                        if (r.hasCssClass(l, 'ace_fold-widget')) return n();
                        u.isOpen && e.$tooltipFollowsMouse && i(s),
                            (a = s),
                            o ||
                                (o = setTimeout(function () {
                                    (o = null), a && !e.isMousePressed ? t() : n();
                                }, 50));
                    }),
                    s.addListener(
                        l.renderer.$gutter,
                ...
                return (
                    ...
                    Object.defineProperty(t, 'annotationLabels', {
                        get: function () {
                            return {
                                ...
                                warning: { singular: l('warning'), plural: l('warnings') },
                                info: { singular: l('information message'), plural: l('information messages') },
                            };
                        },
                        enumerable: !1,
                        configurable: !0,
                    ...
                    (t.prototype.showTooltip = function (e) {
                        ...
                        if (r && i.$showFoldedAnnotations) {
                            for (var s, a = { error: [], warning: [], info: [] }, l = e + 1; l <= r.end.row; l++)
                                if (i.$annotations[l])
                            ...
                            if ('error_fold' === s || 'warning_fold' === s) {
                                var u = ''.concat(t.annotationsToSummaryString(a), ' in folded code.');
                    ...
                    (t.annotationsToSummaryString = function (e) {
                        var n,
                            ...
                            r = [];
                        try {
                            for (var s = o(['error', 'warning', 'info']), a = s.next(); !a.done; a = s.next()) {
                                var l = a.value;
                                if (e[l].length) {
                                    var c =
                                        1 === e[l].length
            ...
            function i(e) {
                function t() {
                    ...
                    (function (e, t) {
                        ...
                        !A || i || r
                            ? (p.moveCursorToPosition(e), (A = n), (k = { x: v, y: w }))
                            : o(k.x, k.y, v, w) > h
                            ? (A = null)
                            : n - A >= c && (p.renderer.scrollCursorIntoView(), (A = null));
                    })(($ = p.renderer.screenToTextCoordinates(v, w)), e),
                        (function (e, t) {
                            var n = Date.now(),
                                i = p.renderer.layerConfig.lineHeight,
                                o = p.renderer.layerConfig.characterWidth,
                                r = p.renderer.scroller.getBoundingClientRect(),
                                s = {
                                    x: { left: v - r.left, right: r.right - v },
                                    y: { top: w - r.top, bottom: r.bottom - w },
                                },
                                a = Math.min(s.x.left, s.x.right),
                                c = Math.min(s.y.top, s.y.bottom),
                                h = { row: e.row, column: e.column };
                            a / o <= 2 && (h.column += s.x.left < s.x.right ? -3 : 2),
                                c / i <= 1 && (h.row += s.y.top < s.y.bottom ? -1 : 1);
                            var u = e.row != h.row,
                                d = e.column != h.column,
                                g = !t || e.row != t.row;
                            u || (d && !g)
                                ? x
                                    ? n - x >= l && p.renderer.scrollCursorIntoView(h)
                                    : (x = n)
                                : (x = null);
                        })($, e);
                }
                function n() {
                    (b = p.selection.toOrientedRange()),
                        (m = p.session.addMarker(b, 'ace_selection', p.getSelectionStyle())),
                        p.clearSelection(),
                ...
                function i() {
                    clearInterval(y),
                        p.session.removeMarker(m),
                        (m = null),
                        p.selection.fromOrientedRange(b),
                        p.isFocused() && !S && p.$resetCursorStyle(),
                        (b = null),
                        ($ = null),
                        (M = 0),
                        (x = null),
                ...
                function g(e) {
                    ...
                    return (
                        n && t.indexOf(i) >= 0
                            ? (o = 'copy')
                            : ['move', 'copymove', 'linkmove', 'all', 'uninitialized'].indexOf(i) >= 0
                            ? (o = 'move')
                ...
                (f.style.cssText = 'top:-100px;position:absolute;z-index:2147483647;opacity:0.5'),
                    (f.textContent = ' ');
                ['dragWait', 'dragWaitEnd', 'startDrag', 'dragReadyEnd', 'onMouseDrag'].forEach(function (t) {
                    e[t] = this[t];
                }, this),
                    p.on('mousedown', this.onMouseDown.bind(e));
                var m,
                    v,
                    w,
                    y,
                ...
                (this.onDragStart = function (e) {
                    ...
                    (n.effectAllowed = p.getReadOnly() ? 'copy' : 'copyMove'),
                        p.container.appendChild(f),
                        n.setDragImage && n.setDragImage(f, 0, 0),
                        setTimeout(function () {
                            p.container.removeChild(f);
                        }),
                        n.clearData(),
                        n.setData('Text', p.session.getTextRange()),
                        (S = !0),
                        this.setState('drag');
                }),
                    (this.onDragEnd = function (e) {
                        if (((L.draggable = !1), (S = !1), this.setState(null), !p.getReadOnly())) {
                            var t = e.dataTransfer.dropEffect;
                            !C && 'move' == t && p.session.remove(p.getSelectionRange()), p.$resetCursorStyle();
                        }
                        this.editor.unsetStyle('ace_dragging'), this.editor.renderer.setCursorStyle('');
                    }),
                    (this.onDragEnter = function (e) {
                        if (!p.getReadOnly() && d(e.dataTransfer))
                            return (
                                (v = e.clientX),
                                (w = e.clientY),
                                m || n(),
                                M++,
                                (e.dataTransfer.dropEffect = C = g(e)),
                                s.preventDefault(e)
                            );
                    }),
                    ...
                    (this.onDragLeave = function (e) {
                        if (--M <= 0 && m) return i(), (C = null), s.preventDefault(e);
                    }),
                    (this.onDrop = function (e) {
                        if ($) {
                            ...
                            if (S)
                                switch (C) {
                                    case 'move':
                                        b = b.contains($.row, $.column) ? { start: $, end: $ } : p.moveText(b, $);
                                        break;
                                    case 'copy':
                                        b = p.moveText(b, $, !0);
                                }
                                ...
                                (b = { start: $, end: p.session.insert($, n) }), p.focus(), (C = null);
                            }
                            return i(), s.preventDefault(e);
                        }
                    }),
                    s.addListener(L, 'dragstart', this.onDragStart.bind(e), p),
                    s.addListener(L, 'dragend', this.onDragEnd.bind(e), p),
                    s.addListener(L, 'dragenter', this.onDragEnter.bind(e), p),
                    s.addListener(L, 'dragover', this.onDragOver.bind(e), p),
                    s.addListener(L, 'dragleave', this.onDragLeave.bind(e), p),
                    s.addListener(L, 'drop', this.onDrop.bind(e), p);
                var R = null;
            }
            function o(e, t, n, i) {
                return Math.sqrt(Math.pow(n - e, 2) + Math.pow(i - t, 2));
                ...
                (this.dragWait = function () {
                    ...
                    (this.onMouseDrag = function (e) {
                        ...
                        a.isIE &&
                            ...
                            o(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) > 3 &&
                            t.dragDrop();
                        'dragWait' === this.state &&
                            o(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) > 0 &&
            ...
            t.addTouchListeners = function (e, t) {
                                ...
                                r.buildDom(
                                    n
                                        ? [
                                              ...
                                              i && ['span', { class: 'ace_mobile-button', action: 'copy' }, 'Copy'],
                                              i && ['span', { class: 'ace_mobile-button', action: 'cut' }, 'Cut'],
                ...
                function s() {
                    ...
                    var e = t.selection.cursor,
                        i = t.renderer.textToScreenCoordinates(e.row, e.column),
                        o = t.renderer.textToScreenCoordinates(0, 0).pageX,
                        r = t.renderer.scrollLeft,
                        s = t.container.getBoundingClientRect();
                    (v.style.top = i.pageY - s.top - 3 + 'px'),
                        i.pageX - s.left < s.width - 70
                            ? ((v.style.left = ''), (v.style.right = '10px'))
                            : ((v.style.right = ''), (v.style.left = o + r - s.left + 'px')),
                        (v.style.display = ''),
                        (v.firstChild.style.display = 'none'),
                        t.on('input', a);
                }
                ...
                function l() {
                    ...
                    var e = t.selection.getRange(),
                        n = e.contains(f.row, f.column);
                    (!e.isEmpty() && n) || (t.selection.moveToPosition(f), t.selection.selectWord()), (w = 'wait'), s();
                }
                var c,
                    h,
                    u,
                ...
                o.addListener(
                    ...
                    o.addListener(
                        ...
                        function (e) {
                            var n = e.touches;
                            if (g || n.length > 1) return clearTimeout(g), (g = null), (u = -1), void (w = 'zoom');
                            ...
                            var a = n[0],
                                p = a.clientX,
                                v = a.clientY;
                            Math.abs(c - p) + Math.abs(h - v) > o && (u = -1),
                                (c = e.clientX = p),
                                (h = e.clientY = v),
                                ($ = C = 0);
                            var S = new i(e, t);
                            if (((f = S.getDocumentPosition()), s - u < 500 && 1 == n.length && !y))
                                b++,
                                    e.preventDefault(),
                                    (e.button = 0),
                                    (function () {
                                        (g = null), clearTimeout(g), t.selection.moveToPosition(f);
                                        var e = b >= 2 ? t.selection.getLineRange(f.row) : t.session.getBracketRange(f);
                                ...
                                var x = t.selection.cursor,
                                    ...
                                    E = function (e, t) {
                                        return (e /= r) * e + (t = t / o - 0.75) * t;
                                    };
                                if (e.clientX < M.left) return void (w = 'zoom');
                                var _ = E(e.clientX - M.left - k.left + T, e.clientY - M.top - k.top + R),
                                    I = E(e.clientX - M.left - L.left + T, e.clientY - M.top - L.top + R);
                                _ < 3.5 && I < 3.5 && (w = _ > I ? 'cursor' : 'anchor'),
                                    (w = I < 3.5 ? 'anchor' : _ < 3.5 ? 'cursor' : 'scroll'),
                                    (g = setTimeout(l, 450));
                            }
                            u = s;
                        },
                        ...
                        function (e) {
                            (m = t.$mouseHandler.isMousePressed = !1),
                                ...
                                'zoom' == w
                                    ? ((w = ''), (y = 0))
                                    : g
                                    ? (t.selection.moveToPosition(f), (y = 0), s())
                                    : 'scroll' == w
                                    ? ((y += 60),
                                      (p = setInterval(function () {
                                          y-- <= 0 && (clearInterval(p), (p = null)),
                                              Math.abs($) < 0.01 && ($ = 0),
                                              Math.abs(C) < 0.01 && (C = 0),
                                              y < 20 && ($ *= 0.9),
                                              y < 20 && (C *= 0.9);
                                          var e = t.session.getScrollTop();
                                          t.renderer.scrollBy(10 * $, 10 * C), e == t.session.getScrollTop() && (y = 0);
                                      }, 10)),
                                      a())
                                    : s(),
                                clearTimeout(g),
                    ...
                    o.addListener(
                        ...
                        function (e) {
                            ...
                            var n = e.touches;
                            if (!(n.length > 1 || 'zoom' == w)) {
                                var o = n[0],
                                    r = c - o.clientX,
                                    s = h - o.clientY;
                                if ('wait' == w) {
                                    if (!(r * r + s * s > 4)) return e.preventDefault();
                                    w = 'cursor';
                                }
                                (c = o.clientX), (h = o.clientY), (e.clientX = o.clientX), (e.clientY = o.clientY);
                                var a = e.timeStamp,
                                    l = a - d;
                                if (((d = a), 'scroll' == w)) {
                                    var u = new i(e, t);
                                    (u.speed = 1),
                                        (u.wheelX = r),
                                        (u.wheelY = s),
                                        10 * Math.abs(r) < Math.abs(s) && (r = 0),
                                        10 * Math.abs(s) < Math.abs(r) && (s = 0),
                                        0 != l && (($ = r / l), (C = s / l)),
                                        t._emit('mousewheel', u),
                                        u.propagationStopped || ($ = C = 0);
                                } else {
                                    var p = new i(e, t).getDocumentPosition();
                                    'cursor' == w
                                        ? t.selection.moveCursorToPosition(p)
                                        : 'anchor' == w && t.selection.setSelectionAnchor(p.row, p.column),
            ...
            var i = e('../lib/event'),
                ...
                u = (function () {
                    function e(e) {
                        ...
                        i.addListener(a, 'click', this.onMouseEvent.bind(this, 'click'), e),
                            i.addListener(a, 'mousemove', this.onMouseMove.bind(this, 'mousemove'), e),
                            ...
                            i.addMouseWheelListener(e.container, this.onMouseWheel.bind(this, 'mousewheel'), e),
                            c(e.container, e);
                        var h = e.renderer.$gutter;
                        i.addListener(h, 'mousedown', this.onMouseEvent.bind(this, 'guttermousedown'), e),
                            i.addListener(h, 'click', this.onMouseEvent.bind(this, 'gutterclick'), e),
                            i.addListener(h, 'dblclick', this.onMouseEvent.bind(this, 'gutterdblclick'), e),
                            i.addListener(h, 'mousemove', this.onMouseEvent.bind(this, 'guttermousemove'), e),
                            i.addListener(a, 'mousedown', n, e),
                            i.addListener(h, 'mousedown', n, e),
                            o.isIE &&
                                e.renderer.scrollBarV &&
                                (i.addListener(e.renderer.scrollBarV.element, 'mousedown', n, e),
                                i.addListener(e.renderer.scrollBarH.element, 'mousedown', n, e)),
                            e.on(
                                'mousemove',
                                function (n) {
                    ...
                    return (
                        ...
                        (e.prototype.captureMouse = function (e, t) {
                            ...
                            var s = this,
                                l = function (e) {
                                    if (e)
                                        return o.isWebKit && !e.which && s.releaseMouse
                                            ? s.releaseMouse()
                                            : ((s.x = e.clientX),
                                              (s.y = e.clientY),
                                              t && t(e),
            ...
            o = function (e) {
                e.on('click', function (t) {
                    ...
                    s &&
                        ...
                        (o.setOption('wrap', !o.getUseWrapMode()), e.renderer.scrollCursorIntoView());
                }),
                        ...
                        if ('foldWidgets' == e.renderer.$gutterLayer.getRegion(t)) {
                            ...
                            if (r) {
                                ...
                                s
                                    ? i.removeFold(s)
                                    : (i.addFold('...', r),
                                      e.renderer.scrollCursorIntoView({ row: r.start.row, column: 0 }));
                            }
                            t.stop();
                        }
                    });
                ...
                r = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.$callKeyboardHandlers = function (e, t, n, i) {
                            for (
                                var r, s = !1, a = this.$editor.commands, l = this.$handlers.length;
                                l-- &&
                                !(
                                    (r = this.$handlers[l].handleKeyboard(this.$data, e, t, n, i)) &&
                                    r.command &&
                                    ((s = 'null' == r.command || a.exec(r.command, this.$editor, r.args, i)) &&
                                        i &&
                                        -1 != e &&
                                        1 != r.passEvent &&
                            ...
                            return (
                                !s &&
                                    -1 == e &&
                                    ((r = { command: 'insertstring' }), (s = a.exec('insertstring', this.$editor, t))),
                                s && this.$editor._signal && this.$editor._signal('keyboardActivity', r),
                                s
                            );
                        }),
    ...
    ace.define('ace/lib/bidiutil', ['require', 'exports', 'module'], function (e, t, n) {
        ...
        function i(e, t, n, i) {
            var o = a ? g : d,
                ...
                x = null,
                A = [];
            if (!i) for (C = 0, i = []; C < n; C++) i[C] = s(e[C]);
            for (l = a, c = !1, !1, h = !1, u = !1, x = 0; x < n; x++) {
                if (
                    ((p = v),
                    (A[x] = f = r(e, i, A, x)),
                    (w = 240 & (v = o[p][f])),
            ...
            if (u)
                for (C = 0; C < n; C++)
                    if (i[C] == $) {
                        t[C] = a;
                        for (var k = C - 1; k >= 0 && i[k] == S; k--) t[k] = a;
                    }
        }
        function o(e, t, n) {
            if (!(l < e))
                if (1 != e || a != p || h)
                    for (var i, o, r, s, c = n.length, u = 0; u < c; ) {
                        if (t[u] >= e) {
                            for (i = u + 1; i < c && t[i] >= e; ) i++;
                            for (o = u, r = i - 1; o < r; o++, r--) (s = n[o]), (n[o] = n[r]), (n[r] = s);
                            u = i;
                        }
                        u++;
                    }
            ...
            switch (d) {
                ...
                case x:
                    return i < 1 ||
                        ...
                        : (c && (r = w), r == o ? r : y);
                case A:
                    return (o = i > 0 ? n[i - 1] : b) == v && i + 1 < t.length && t[i + 1] == v ? v : y;
                case k:
                    if (i > 0 && n[i - 1] == v) return v;
                    if (c) return y;
                    for (l = i + 1, s = t.length; l < s && t[l] == k; ) l++;
                    return l < s && t[l] == v ? v : y;
                case L:
                    for (s = t.length, l = i + 1; l < s && t[l] == L; ) l++;
                    if (l < s) {
                        var g = e[i],
                            p = (g >= 1425 && g <= 2303) || 64286 == g;
                        if (((o = t[l]), p && (o == m || o == C))) return m;
                    }
                    return i < 1 || (o = t[i - 1]) == b ? y : n[i - 1];
                case b:
                    return (c = !1), (h = !0), a;
                case $:
                    return (u = !0), y;
        ...
        (t.L = f),
            ...
            (t.doBidiReorder = function (e, n, r) {
                ...
                var s = e.split(''),
                    ...
                    h = [];
                (a = r ? p : 0), i(s, h, s.length, n);
                for (var u = 0; u < l.length; l[u] = u, u++);
                o(2, h, l), o(1, h, l);
                for (u = 0; u < l.length - 1; u++)
                    n[u] === w
                        ? (h[u] = t.AN)
                        : h[u] === m && ((n[u] > C && n[u] < M) || n[u] === y || n[u] === I)
                        ? (h[u] = t.ON_R)
                        : u > 0 &&
                          'ل' === s[u - 1] &&
                          /\u0622|\u0623|\u0625|\u0627/.test(s[u]) &&
                ...
                for (u = 0; u < l.length; u++) c[u] = h[l[u]];
                return { logicalFromVisual: l, bidiLevels: c };
            }),
            (t.hasBidiCharacters = function (e, t) {
                for (var n = !1, i = 0; i < e.length; i++)
                    (t[i] = s(e.charAt(i))), !n && (t[i] == m || t[i] == C || t[i] == w) && (n = !0);
                return n;
            }),
                    ...
                    return (
                                ...
                                r &&
                                    ...
                                    t > 0 && r.length
                                        ? ((this.wrapIndent = r.indent),
                                          (this.wrapOffset = this.wrapIndent * this.charWidths[i.L]),
                                          (this.line =
                                              t < r.length
                                                  ? this.line.substring(r[t - 1], r[t])
                                                  : this.line.substring(r[r.length - 1])))
                                        : (this.line = this.line.substring(0, r[t])),
                                    t == r.length && (this.line += this.showInvisibles ? n : i.DOT));
                        ...
                        (e.prototype.updateBidiMap = function () {
                            ...
                            i.hasBidiCharacters(this.line, e) || this.isRtlDir
                                ? (this.bidiMap = i.doBidiReorder(this.line, e, this.isRtlDir))
                                : (this.bidiMap = {});
                        }),
                        ...
                        (e.prototype.getPosLeft = function (e) {
                            ...
                            return (
                                !this.session.getOverwrite() && e > t && r[o] % 2 == 0 && (s += this.charWidths[r[o]]),
                        ...
                        (e.prototype.getSelections = function (e, t) {
                            ...
                            for (var d, g = 0; g < o.length; g++)
                                (d = i.logicalFromVisual[g]),
                                    ...
                                    (s += this.charWidths[n]),
                                    (h = c);
                            if ((c && g === o.length && r.push({ left: u, width: s - u }), this.isRtlDir))
                ...
                i.implement(this, r),
                    ...
                    (this.wouldMoveIntoSoftTab = function (e, t, n) {
                        ...
                        return (
                            ...
                            this.session.isTabStop(e) && this.doc.getLine(e.row).slice(i, o).split(' ').length - 1 == t
                        );
                    }),
                    ...
                    (this.moveCursorLongWordLeft = function () {
                        ...
                        if ((e = this.session.getFoldAt(t, n, -1))) this.moveCursorTo(e.start.row, e.start.column);
                            ...
                            this.session.tokenRe.exec(r) &&
                                ((n -= this.session.tokenRe.lastIndex), (this.session.tokenRe.lastIndex = 0)),
            ...
            r = (function () {
                        ...
                        for (
                            ...
                            if (
                                ...
                                Array.isArray(c.token)
                                    ...
                                    u > 1 &&
                                        (/\\\d/.test(c.regex)
                                            ? (h = c.regex.replace(/\\([0-9]+)/g, function (e, t) {
                                                  return '\\' + (parseInt(t, 10) + o + 1);
                                              }))
                                            : ((u = 1), (h = this.removeCapturingGroups(c.regex))),
                ...
                return (
                    ...
                    (e.prototype.$arrayTokens = function (e) {
                        ...
                        if (!t) return 'text';
                        for (var n = [], i = this.tokenArray, o = 0, r = i.length; o < r; o++)
                            ...
                            e.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g, function (e, t, r, s, a, l) {
                                return (
                                    i
                                        ...
                                        ? (i = !0)
                                        : s
                                        ? (n == o.stack && ((o.end = l + 1), (o.stack = -1)), n--)
                                        : r && (n++, 1 != r.length && ((o.stack = n), (o.start = l))),
                                    e
                                );
                            }),
                                null != o.end &&
                    ...
                    (e.prototype.getLineTokens = function (e, t) {
                        ...
                        for (var l, c = [], h = 0, u = 0, d = { type: null, value: '' }; (l = a.exec(e)); ) {
                            ...
                            for (var w = 0; w < l.length - 2; w++)
                                if (void 0 !== l[w + 1]) {
                                    (g = (p = r[s[w]]).onMatch ? p.onMatch(f, i, n, e) : p.token),
                                        p.next &&
                                            ((i = 'string' == typeof p.next ? p.next : p.next(i, n)),
                                            (r = this.states[i]) ||
                            ...
                            if (((h = m), u++ > o)) {
                                for (
                                    ...
                                    d.type && c.push(d), (d = { value: e.substring(h, (h += 500)), type: 'overflow' });
                                (i = 'start'), (n = []);
                                break;
                            }
                        }
                ...
                Object.keys(i).forEach(function o(r) {
                    ...
                    for (var a = 0; a < s.length; a++) {
                        ...
                        if (h && Array.isArray(h)) {
                            var u = l.stateName;
                            u || ('string' != typeof (u = l.token) && (u = u[0] || ''), i[u] && (u += n++)),
                                (i[u] = h),
                                (l.next = u),
                                o(u);
                        } else 'pop' == h && (l.next = t);
                        if ((l.push && ((l.nextState = l.next || l.push), (l.next = e), delete l.push), l.rules))
                            for (var d in l.rules)
                                i[d] ? i[d].push && i[d].push.apply(i[d], l.rules[d]) : (i[d] = l.rules[d]);
                    ...
                    return (
                        ...
                        Object.keys(e).forEach(function (t) {
                            for (var r = e[t].split(i || '|'), s = r.length; s--; ) {
                                var a = r[s];
                                this.$keywordList.push(a), n && (a = a.toLowerCase()), (o[a] = t);
                            }
                        }, this),
                        (e = null),
                        n
        ...
        function (e, t, n) {
            ...
            var i,
                ...
                d = function (e) {
                    ...
                    if (
                        (e.multiSelect &&
                            ((t = e.selection.index),
                            h.rangeCount != e.multiSelect.rangeCount && (h = { rangeCount: e.multiSelect.rangeCount })),
                        h[t])
                    )
                        return (i = h[t]);
                    i = h[t] = {
                ...
                p = function (e) {
                    (e = e || {}),
                        this.add('braces', 'insertion', function (t, n, o, r, s) {
                            ...
                            if ('{' == s) {
                                ...
                                if (p.isSaneInsertion(o, r))
                                    return /[\]\}\)]/.test(c[l.column]) || o.inMultiSelectMode || e.braces
                                        ? (p.recordAutoInsert(o, r, '}'), { text: '{}', selection: [1, 1] })
                                        : (p.recordMaybeInsert(o, r, '{'), { text: '{', selection: [1, 1] });
                            } else if ('}' == s) {
                                ...
                                if ('\n' == s || '\r\n' == s) {
                                    ...
                                    return { text: '\n' + w + '\n' + v + f, selection: [1, w.length, 1, w.length] };
                                }
                                p.clearMaybeInsertedClosing();
                            }
                        }),
                        this.add('braces', 'deletion', function (e, t, n, o, r) {
                            ...
                            if (!r.isMultiLine() && '{' == s) {
                                if ((d(n), '}' == o.doc.getLine(r.start.row).substring(r.end.column, r.end.column + 1)))
                        ...
                        this.add('parens', 'insertion', function (e, t, n, i, o) {
                            if ('(' == o) {
                                ...
                                if (p.isSaneInsertion(n, i))
                                    return p.recordAutoInsert(n, i, ')'), { text: '()', selection: [1, 1] };
                            } else if (')' == o) {
                                d(n);
                                ...
                                if (')' == l.substring(a.column, a.column + 1))
                                    if (
                                        null !== i.$findOpeningBracket(')', { column: a.column + 1, row: a.row }) &&
                        ...
                        this.add('string_dquotes', 'insertion', function (e, t, n, i, o) {
                            ...
                            if (1 == o.length && r[o]) {
                                ...
                                if ('' !== l && (1 != l.length || !r[l]) && n.getWrapBehavioursEnabled())
                                    return g(a, l, s, s);
                                if (!l) {
                                    ...
                                    if (f == s) (w = y !== b) && /string\.end/.test(v.type) && (w = !1);
                                        ...
                                        if ((!(x && x[s] && x[s].test(p)) && C) || S) return null;
                        ...
                        !1 !== e.closeDocComment &&
                            this.add('doc comment end', 'insertion', function (e, t, n, i, o) {
                                if ('doc-start' === e && ('\n' === o || '\r\n' === o) && n.selection.isEmpty()) {
                                    ...
                                    if (/\s*\*/.test(a))
                                        return /^\s*\*/.test(s)
                                            ? { text: o + l + '* ', selection: [1, 3 + l.length, 1, 3 + l.length] }
                                            : { text: o + l + ' * ', selection: [1, 3 + l.length, 1, 3 + l.length] };
            ...
            (p.isSaneInsertion = function (e, t) {
                ...
                (p.recordAutoInsert = function (e, t, n) {
                    ...
                    this.isAutoInsertedClosing(o, r, i.autoInsertedLineEnd[0]) || (i.autoInsertedBrackets = 0),
                ...
                (this.$defaultBehaviour = new s()),
                    ...
                    (this.toggleCommentLines = function (e, t, n, i) {
                        ...
                        if (this.lineCommentStart) {
                            ...
                            else (m = l.escapeRegExp(this.lineCommentStart)), (p = this.lineCommentStart);
                            ...
                            var d = p + ' ',
                                g =
                                    ((w = function (e, t) {
                                        (s && !/\S/.test(e)) ||
                                            (g(e, c, c)
                                                ? r.insertInLine({ row: t, column: c }, d)
                            ...
                            var p = this.blockComment.start,
                                ...
                                m = new RegExp('^(\\s*)(?:' + l.escapeRegExp(p) + ')'),
                                v = new RegExp('(?:' + l.escapeRegExp(f) + ')\\s*$'),
                                w = function (e, t) {
                                    b(e, t) ||
                                        (s && !/\S/.test(e)) ||
                                        (r.insertInLine({ row: t, column: e.length }, f),
                                        r.insertInLine({ row: t, column: c }, p));
                                },
                                y = function (e, t) {
                                    var n;
                                    (n = e.match(v)) && r.removeInLine(t, e.length - n[0].length, e.length),
                                        (n = e.match(m)) && r.removeInLine(t, n[1].length, n[0].length);
                                },
                                b = function (e, n) {
                        ...
                        o(function (e, t) {
                            var n = e.search(/\S/);
                            -1 !== n ? (n < c && (c = n), a && !b(e, t) && (a = !1)) : $ > e.length && ($ = e.length);
                        }),
                            c == 1 / 0 && ((c = $), (s = !1), (a = !1)),
                            ...
                            if (a && /comment/.test(a.type)) {
                                ...
                                for (
                                    ...
                                    if (-1 != (m = a.value.indexOf(o.end))) {
                                        (g = f.getCurrentTokenRow()), (p = f.getCurrentTokenColumn() + m);
    ...
    ace.define(
        ...
        function (e, t, n) {
                ...
                s = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.onChange = function (e) {
                            if (!((e.start.row == e.end.row && e.start.row != this.row) || e.start.row > this.row)) {
                                var t = (function (e, t, n) {
                                    var o = 'insert' == e.action,
                                        r = (o ? 1 : -1) * (e.end.row - e.start.row),
                                        s = (o ? 1 : -1) * (e.end.column - e.start.column),
                                        a = e.start,
                                        l = o ? a : e.end;
                                    return i(t, a, n)
                                        ? { row: t.row, column: t.column }
                                        : i(l, t, !n)
                                        ? { row: t.row + r, column: t.column + (t.row == l.row ? s : 0) }
                        ...
                        (e.prototype.setPosition = function (e, t, n) {
                            var i;
                            if (
                                ((i = n ? { row: e, column: t } : this.$clipPositionToDocument(e, t)),
            ...
            (s.prototype.$insertRight = !1), o.implement(s.prototype, r), (t.Anchor = s);
        }
    ),
    ace.define(
        'ace/document',
                ...
                l = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.insertInLine = function (e, t) {
                            ...
                            return (
                                this.applyDelta({ start: n, end: i, action: 'insert', lines: [t] }, !0),
                                this.clonePos(i)
                            );
                        }),
                        ...
                        (e.prototype.removeFullLines = function (e, t) {
                            ...
                            var n =
                                    (t = Math.min(Math.max(0, t), this.getLength() - 1)) == this.getLength() - 1 &&
                                    e > 0,
                ...
                r = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.update = function (e, t, n, r) {
                            if (this.regExp)
                                for (var s = r.firstRow, a = r.lastRow, l = {}, c = s; c <= a; c++) {
                                    var h = this.cache[c];
                                    null == h &&
                                        ((h = i.getMatchOffsets(n.getLine(c), this.regExp)).length > this.MAX_RANGES &&
                                    ...
                                    for (var u = h.length; u--; ) {
                                        var d = h[u].toScreenRange(n),
                                            g = d.toString();
                                        l[g] || ((l[g] = !0), t.drawSingleLineMarker(e, d, this.clazz, r));
                                    }
                                }
                        }),
                        e
                ...
                return (
                    ...
                    (e.prototype.merge = function () {
                        ...
                        for (var n, o = t[0], r = 1; r < t.length; r++) {
                            ...
                            s < 0 ||
                                ((0 != s || n.isEmpty() || o.isEmpty()) &&
                                    (i(n.end, o.end) < 0 && ((n.end.row = o.end.row), (n.end.column = o.end.column)),
                                    t.splice(r, 1),
                                    e.push(o),
                                    (o = n),
                                    r--));
                ...
                return (
                    ...
                    (t.prototype.addSubFold = function (e) {
                        if (!this.range.isEqual(e)) {
                            o(e, this.start);
                            for (
                                var t = e.start.row, n = e.start.column, i = 0, r = -1;
                                i < this.subFolds.length && 1 == (r = this.subFolds[i].range.compare(t, n));
                                i++
                            );
                            ...
                            for (
                                r = -1;
                                l < this.subFolds.length && 1 == (r = this.subFolds[l].range.compare(t, n));
                                l++
                            );
                            0 == r && l++;
                            for (
                                var c = this.subFolds.splice(i, l - i, e), h = 0 == r ? c.length - 1 : c.length, u = a;
                                u < h;
                                u++
                            )
                                e.addSubFold(c[u]);
                ...
                (this.getFoldAt = function (e, t, n) {
                    ...
                    (this.getFoldStringAt = function (e, t, n, i) {
                        ...
                        return (
                            ...
                            -1 == n ? o.substring(0, t - s.end.column) : 1 == n ? o.substring(t - s.end.column) : o
                        );
                    }),
                    ...
                    (this.addFold = function (e, t) {
                        var n,
                            i = this.$foldData,
                            s = !1;
                        e instanceof r ? (n = e) : ((n = new r(t, e)).collapseChildren = t.collapseChildren),
                    ...
                    (this.toggleFold = function (e) {
                        ...
                        if (i.isEmpty()) {
                            ...
                            (n = this.findMatchingBracket(o))
                                ...
                                : (n = this.findMatchingBracket({ row: o.row, column: o.column + 1 }))
                                ? (1 == i.comparePoint(n) ? (i.end = n) : (i.start = n), i.start.column++)
                    ...
                    (this.getCommentFoldRange = function (e, t, n) {
                        ...
                        if (r && /^comment|string/.test(a)) {
                            ...
                            if (
                                ...
                                (c.start.column =
                                    o.getCurrentTokenColumn() + (/^comment.start/.test(r.type) ? r.value.length : 2)),
                                (o = new s(this, e, t)),
                                -1 != n)
                            ) {
                                var h = -1;
                                ...
                                } while (r && l.test(r.type) && !/^comment.start/.test(r.type));
                                r = o.stepBackward();
                            } else r = o.getCurrentToken();
                            return (
                                (c.end.row = o.getCurrentTokenRow()),
                                (c.end.column = o.getCurrentTokenColumn()),
                                /^comment.end/.test(r.type) || (c.end.column += r.value.length - 2),
                                c
                            );
                        }
                    }),
                            ...
                            for (var r = (e = e || 0); r < t; r++)
                                if ((null == o[r] && (o[r] = this.getFoldWidget(r)), 'start' == o[r] && (!i || i(r)))) {
                                    ...
                                    s &&
                                        ...
                                        s.end.row <= t &&
                                        s.start.row >= e &&
                                        ((r = s.end.row), (s.collapseChildren = n), this.addFold('...', s));
                                }
                        }
                    }),
                    ...
                    (this.$toggleFoldWidget = function (e, t) {
                        if (this.getFoldWidget) {
                            ...
                            if (t.siblings) {
                                ...
                                t.children
                                    ? ((c = s ? s.end.row : this.getLength()), this.foldAll(e + 1, c, t.all ? 1e4 : 0))
                                    : s && (t.all && (s.collapseChildren = 1e4), this.addFold('...', s));
                            return s;
                        }
                    }),
                ...
                (this.findMatchingBracket = function (e, t) {
                    ...
                    (this.getMatchingBracketRanges = function (e, t) {
                        ...
                        var a = new o(e.row, e.column - 1, e.row, e.column),
                            l = s[1] ? this.$findClosingBracket(s[1], e) : this.$findOpeningBracket(s[2], e);
                        ...
                        if (t && -1 === t.type.indexOf('tag-name'))
                            do {
                                (t = i ? e.stepBackward() : e.stepForward()) &&
                                    ('/>' === t.value ? (i = !0) : -1 !== t.type.indexOf('tag-name') && (n = !0));
                            } while (t && !n);
                        return t;
                    }),
                            ...
                            if (((n = t), (t = e.stepForward()))) {
                                ...
                                if (-1 !== t.type.indexOf('tag-name')) {
                                    ...
                                    (g =
                                        ...
                                        (h = new o(l.end.row, l.end.column, l.end.row, l.end.column + 1));
                            }
                        } while (t && s >= 0);
                        if (a && h && u && g && l && d)
                            return {
                                openTag: new o(a.start.row, a.start.column, h.end.row, h.end.column),
                                closeTag: new o(u.start.row, u.start.column, g.end.row, g.end.column),
                                openTagName: l,
                                closeTagName: d,
                            };
                    }),
                    (this.$findOpeningTag = function (e, t) {
                        ...
                        if ((t = e.stepForward()) && '>' === t.value) {
                            ...
                            do {
                                if (
                                    ...
                                    if (-1 !== t.type.indexOf('tag-name')) {
                                        ...
                                        for (var f = 0, m = n; m; ) {
                                            if (-1 !== m.type.indexOf('tag-name') && m.value === i) {
                                                r--;
                                                break;
                                            }
                                            if ('<' === m.value) break;
                            ...
                            return g && p && c && u && d && h
                                ? {
                                      openTag: new o(g.start.row, g.start.column, p.end.row, p.end.column),
                                      closeTag: new o(c.start.row, c.start.column, u.end.row, u.end.column),
                                      openTagName: d,
                                      closeTagName: h,
                                  }
                                : void 0;
    ...
    ace.define(
        ...
        function (e, t, n) {
                ...
                f = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.getTokenAt = function (e, t) {
                            ...
                            } else for (r = 0; r < i.length && !((o += i[r].value.length) >= t); r++);
                        ...
                        (e.prototype.addMarker = function (e, t, n, i) {
                            ...
                            return (
                                i
                                    ? ((this.$frontMarkers[o] = r), this._signal('changeFrontMarker'))
                                    : ((this.$backMarkers[o] = r), this._signal('changeBackMarker')),
                                o
                            );
                        }),
                        ...
                        (e.prototype.moveText = function (e, t, n) {
                            ...
                            if (!n) {
                                ...
                                (c = s ? -e.end.column : e.start.column - e.end.column) &&
                                    (r.start.row == e.end.row && r.start.column > e.end.column && (r.start.column += c),
                                    r.end.row == e.end.row && r.end.column > e.end.column && (r.end.column += c)),
                                    s && r.start.row >= e.end.row && ((r.start.row += s), (r.end.row += s));
                            }
                            if (((r.end = this.insert(r.start, i)), o.length)) {
                                ...
                                this.addFolds(
                                    o.map(function (e) {
                                        return (
                                            (e = e.clone()).start.row == a.row && (e.start.column += c),
                        ...
                        (e.prototype.$moveLines = function (e, t, n) {
                            ...
                            var r = new u(e, 0, t, Number.MAX_VALUE),
                            ...
                            if (((this.$updating = !0), 0 != a))
                                if ('remove' === n) {
                                    ...
                                    if ((f = this.getFoldLine(o.row))) {
                                        f.addRemoveChars(o.row, o.column, i.column - o.column), f.shiftRow(-a);
                                        var u = this.getFoldLine(r);
                                        u && u !== f && (u.merge(f), (f = u)), (h = c.indexOf(f) + 1);
                                    }
                                    for (; h < c.length; h++) {
                                    ...
                                    if ((f = this.getFoldLine(r))) {
                                        ...
                                        0 == p
                                            ? (f = f.split(i.row, i.column)) &&
                                              (f.shiftRow(a), f.addRemoveChars(s, 0, o.column - i.column))
                                            : -1 == p && (f.addRemoveChars(r, 0, o.column - i.column), f.shiftRow(a)),
                                            (h = c.indexOf(f) + 1);
                                    }
                                    for (; h < c.length; h++) {
                                        var f;
                                ...
                                (a = Math.abs(e.start.column - e.end.column)),
                                    ...
                                    (f = this.getFoldLine(r)) && f.addRemoveChars(r, i.column, a);
                            return (
                                t &&
                                    ...
                                    ? ((n = []),
                                      i.walk(
                                          function (e, t, i, r) {
                                              var s;
                                              if (null != e) {
                                                  (s = this.$getDisplayTokens(e, n.length))[0] = w;
                                                  for (var a = 1; a < s.length; a++) s[a] = y;
                        ...
                        (e.prototype.$computeWrapSplits = function (e, t, n) {
                            function i() {
                                ...
                                return c && !1 !== h && (t += n), Math.min(t, u);
                            }
                            function o(t) {
                                for (var n = t - a, o = a; o < t; o++) {
                                    var s = e[o];
                                    (12 !== s && 2 !== s) || (n -= 1);
                                }
                                r.length || ((d = i()), (r.indent = d)), (l += n), r.push(l), (a = t);
                            }
                            ...
                            for (
                                var r = [],
                                    ...
                                    u = t <= Math.max(2 * n, 8) || !1 === h ? 0 : Math.floor(t / 2),
                                    d = 0;
                                s - a > t - d;
                                ...
                                if (e[g - 1] >= $ && e[g] >= $) o(g);
                                    ...
                                    for (var p = Math.max(g - (t - (t >> 2)), a - 1); g > p && e[g] < w; ) g--;
                                    if (c) {
                                        for (; g > p && e[g] < w; ) g--;
                                        for (; g > p && e[g] == b; ) g--;
                                    } else for (; g > p && e[g] < $; ) g--;
                                    g > p ? o(++g) : (e[(g = a + t)] == v && g--, o(g - d));
                                } else {
                                    for (; g != a - 1 && e[g] != w; g--);
                                    if (g > a) {
                                        o(g);
                        ...
                        (e.prototype.$getDisplayTokens = function (e, t) {
                            ...
                            for (var r = 0; r < e.length; r++) {
                                ...
                                if (9 == s) {
                                    (n = this.getScreenTabSize(o.length + t)), o.push(C);
                                    for (var a = 1; a < n; a++) o.push(S);
                                } else
                                    32 == s
                                        ? o.push($)
                                        : (s > 39 && s < 48) || (s > 57 && s < 64)
                        ...
                        (e.prototype.screenToDocumentPosition = function (e, t, n) {
                            ...
                            for (
                                var g = this.getLength() - 1, p = this.getNextFoldLine(r), f = p ? p.start.row : 1 / 0;
                            ...
                            if (this.$useWrapMode) {
                                ...
                                w &&
                                    ...
                                    v > 0 &&
                                        w.length &&
                                        ((m = w.indent), (s = w[v - 1] || w[w.length - 1]), (i = i.substring(s))));
                            }
                            return (
                                void 0 !== n &&
                        ...
                        (e.prototype.documentToScreenPosition = function (e, t) {
                            ...
                            for (var d = this.getNextFoldLine(a), g = d ? d.start.row : 1 / 0; a < e; ) {
                                ...
                                (o += this.getRowLength(a)),
                                    (a = s),
                                    u && (this.$docRowCache.push(a), this.$screenRowCache.push(o));
                            }
                            var p = '';
                            d && a >= g
                                ? ((p = this.getFoldDisplayLine(d, e, t)), (r = d.start.row))
                            ...
                            if (this.$useWrapMode) {
                                ...
                                if (m) {
                                    ...
                                    (p = p.substring(m[v - 1] || 0, p.length)), (f = v > 0 ? m.indent : 0);
                                }
                            }
                            return (
                                this.lineWidgets &&
                            ...
                            if (this.$useWrapMode)
                                for (
                                    var n = this.$wrapData.length,
                                        i = 0,
                                        o = ((a = 0), (t = this.$foldData[a++]) ? t.start.row : 1 / 0);
                                    i < n;
            ...
            (f.$uid = 0),
                ...
                (f.prototype.isFullWidth = i),
                o.implement(f.prototype, l);
            var m = 1,
                v = 2,
                w = 3,
                y = 4,
            ...
            e('./edit_session/folding').Folding.call(f.prototype),
                ...
                a.defineOptions(f.prototype, 'session', {
                    wrap: {
                        set: function (e) {
                            if (
                                (e && 'off' != e
                    ...
                    return (
                        ...
                        (e.prototype.findAll = function (e) {
                            ...
                            if (t.$isMultiLine) {
                                ...
                                e: for (var u = a.offset || 0; u <= h; u++) {
                                    for (var d = 0; d < c; d++) if (-1 == o[u + d].search(a[d])) continue e;
                                    var g = o[u],
                                        p = o[u + c - 1],
                                        f = g.length - g.match(a[0])[0].length,
                                        m = p.match(a[c - 1])[0].length;
                                    (l && l.end.row === u && l.end.column > f) ||
                                        (s.push((l = new r(u, f, u + c - 1, m))), c > 2 && (u = u + c - 2));
                                }
                            } else
                            ...
                            if (n) {
                                var b = n.start.column,
                                    $ = n.end.column;
                                for (v = 0, d = s.length - 1; v < d && s[v].start.column < b && 0 == s[v].start.row; )
                                    v++;
                                for (
                                ...
                                for (s = s.slice(v, d + 1), v = 0, d = s.length; v < d; v++)
                                    (s[v].start.row += n.start.row), (s[v].end.row += n.start.row);
                            }
                            return s;
                        }),
                        (e.prototype.replace = function (e, t) {
                        ...
                        (e.prototype.$matchIterator = function (e, t) {
                            ...
                            var i = 1 == t.backwards,
                                ...
                                r = t.range,
                                s = t.start;
                            s || (s = r ? r[i ? 'end' : 'start'] : e.selection.getRange()),
                            ...
                            if (i)
                                var c = function (e) {
                                    ...
                                    if (!u(n, s.column, e)) {
                                        ...
                                        if (0 != t.wrap)
                                            for (n = l, a = s.row; n >= a; n--) if (u(n, Number.MAX_VALUE, e)) return;
                                    }
                                };
                            else
                                c = function (e) {
                ...
                function () {
                    ...
                    (this.addCommand = function (e) {
                        ...
                        (this.bindKey = function (e, t, n) {
                            if (
                                ('object' == typeof e && e && (null == n && (n = e.position), (e = e[this.platform])),
                                e)
                            )
                        ...
                        (this.handleKeyboard = function (e, t, n, i) {
                            if (!(i < 0)) {
                                ...
                                return (
                                    e.$keyChain &&
                                        ((e.$keyChain += ' ' + o), (r = this.commandKeyBinding[e.$keyChain] || r)),
            ...
            t.commands = [
                    ...
                    exec: function (e) {
                        for (
                            var t = e.selection.isBackwards(),
                                ...
                                r = e.session.doc.getLine(n.row).length,
                        ...
                        i.row + 1 < e.session.doc.getLength() - 1 && (l += e.session.doc.getNewLineCharacter()),
                            e.clearSelection(),
                            e.session.doc.replace(new s(n.row, 0, i.row + 2, 0), l),
                            a > 0
                                ? (e.selection.moveCursorTo(n.row, n.column), e.selection.selectTo(n.row, n.column + a))
                                : ((r = e.session.doc.getLine(n.row).length > r ? r + 1 : r),
                                  e.selection.moveCursorTo(n.row, r));
                    },
                    multiSelectAction: 'forEach',
                    readOnly: !0,
                },
                {
                    ...
                    exec: function (e) {
                        ...
                        for (var r = 0; r < i.length; r++)
                            r == i.length - 1 &&
                                (i[r].end.row !== t || i[r].end.column !== n) &&
                                o.push(new s(i[r].end.row, i[r].end.column, t, n)),
                                0 === r
                                    ? (0 !== i[r].start.row || 0 !== i[r].start.column) &&
                                      o.push(new s(0, 0, i[r].start.row, i[r].start.column))
                                    : o.push(
                                          new s(
                                              i[r - 1].end.row,
                                              i[r - 1].end.column,
            ...
            o = (function () {
                ...
                return (
                    ...
                    (e.prototype.updateOnFold = function (e, t) {
                        ...
                        if (n && e.action) {
                            for (
                                var i = e.data, o = i.start.row, r = i.end.row, s = 'add' == e.action, a = o + 1;
                                a < r;
                                a++
                            )
                                n[a] && (n[a].hidden = s);
                    ...
                    (e.prototype.addLineWidget = function (e) {
                        ...
                        e.html && !e.el && ((e.el = i.createElement('div')), (e.el.innerHTML = e.html)),
                            e.text && !e.el && ((e.el = i.createElement('div')), (e.el.textContent = e.text)),
                            e.el &&
                                ...
                                if (a && a.el)
                                    if (a.hidden) a.el.style.top = -100 - (a.pixelHeight || 0) + 'px';
                                        ...
                                        a.fixedWidth || (c -= t.scrollLeft),
                                            ...
                                            a.fullWidth &&
                                                a.screenWidth &&
                                                (a.el.style.minWidth = n.width + 2 * n.padding + 'px'),
                                            a.fixedWidth
                    ...
                    return (
                        ...
                        (e.prototype.$onGutterKeyDown = function (e) {
                            if (this.annotationTooltip.isOpen)
                                return (
                                    e.preventDefault(), void (e.keyCode === i.escape && this.annotationTooltip.hide())
                                );
                                ...
                                if (e.keyCode !== i.up)
                                    if (e.keyCode !== i.down)
                                        if (
                                            ...
                                            e.keyCode === i.right && (e.preventDefault(), this.$switchLane('fold')),
                                            e.keyCode !== i.enter && e.keyCode !== i.space)
                                        );
                                        else
                                            switch ((e.preventDefault(), this.activeLane)) {
                                                case 'fold':
                                                    if (
                                                        ...
                                                        var n = this.$rowIndexToRow(this.activeRowIndex);
                                                        this.editor.session.onFoldWidgetClick(
                                                            ...
                                                            setTimeout(
                                                                function () {
                                                                    this.$rowIndexToRow(this.activeRowIndex) !== n &&
                                                                        (this.$blurFoldWidget(this.activeRowIndex),
                                                                        (this.activeRowIndex = this.$rowToRowIndex(n)),
                                                ...
                                                case 'annotation':
                                                    var o =
                                                        ...
                                                        r = this.annotationTooltip.getElement().style;
                                                    (r.left = o.right + 'px'),
                                                        (r.top = o.bottom + 'px'),
                        ...
                        (e.prototype.$findNearestFoldWidget = function (e) {
                            ...
                            for (var t = 0; e - t > 0 || e + t < this.lines.getLength() - 1; ) {
    ...
    ace.define(
        ...
        function (e, t, n) {
                    ...
                    return (
                                    ...
                                    setTimeout(function () {
                                        ...
                                        if (t && !t.destroyed) {
                                            ...
                                            var n = e.getCursorPosition(),
                                                ...
                                                o = i && i.$getDirectionForHighlight && i.$getDirectionForHighlight(e),
                                                r = t.getMatchingBracketRanges(n, o);
                                            if (!r) {
                                                var s = new y(t, n.row, n.column).getCurrentToken();
                                            ...
                                            if (
                                                (!r && t.$mode.getMatching && (r = t.$mode.getMatching(e.session)), r)
                                            ) {
                                                var l = 'ace_bracket';
                                                Array.isArray(r)
                                                    ...
                                                    2 == r.length &&
                                                        (0 == p.comparePoints(r[0].end, r[1].start)
                                                            ...
                                                            : 0 == p.comparePoints(r[0].start, r[1].end) &&
                        ...
                        (e.prototype.getCopyText = function () {
                            ...
                            if (!e && this.$copyWithEmptySelection) {
                                n = !0;
                                for (var i = this.selection.getAllRanges(), o = 0; o < i.length; o++) {
                                    var r = i[o];
                        ...
                        (e.prototype.$handlePaste = function (e) {
                            ...
                            if (!this.inMultiSelectMode || this.inVirtualSelectionMode)
                                n ? i.insert({ row: this.selection.lead.row, column: 0 }, t) : this.insert(t);
                            else if (n)
                                ...
                                r &&
                                    ...
                                    (2 == r.selection.length
                                        ? this.selection.setSelectionRange(
                                              new p(o.row, c + r.selection[0], o.row, c + r.selection[1])
                                          )
                                        : this.selection.setSelectionRange(
                                              new p(
                                                  o.row + r.selection[0],
                        ...
                        (e.prototype.autoIndent = function () {
                            ...
                            for (var r, s, a, l = '', c = '', h = '', u = n.getTabString(), d = e; d <= t; d++)
                                d > 0 &&
                                    ((l = n.getState(d - 1)),
                                    (c = n.getLine(d - 1)),
                                    ...
                                    (r = n.getLine(d)),
                                    h !== (s = i.$getIndent(r)) &&
                                        (s.length > 0 && ((a = new p(d, 0, d, s.length)), n.remove(a)),
                        ...
                        (e.prototype.applyComposition = function (e, t) {
                            ...
                            ((e || !this.selection.isEmpty()) && this.insert(e, !0), t.restoreStart || t.restoreEnd) &&
                        ...
                        (e.prototype.transposeLetters = function () {
                            if (this.selection.isEmpty()) {
                                ...
                                if (0 !== t) {
                                    ...
                                    t < o.length
                                        ? ((n = o.charAt(t) + o.charAt(t - 1)), (i = new p(e.row, t - 1, e.row, t + 1)))
                        ...
                        (e.prototype.indent = function () {
                            ...
                            if (!(t.start.row < t.end.row)) {
                                ...
                                if (this.session.getUseSoftTabs())
                                    ...
                                    for (l = a % r; ' ' == i[t.start.column - 1] && l; ) t.start.column--, l--;
                            ...
                            if (!isNaN(parseFloat(o)) && isFinite(o)) {
                                ...
                                if (r) {
                                    ...
                                    this.session.replace(h, c),
                                        this.moveCursorTo(t, Math.max(r.start + 1, n + c.length - r.value.length));
                                }
                        ...
                        (e.prototype.toggleWord = function () {
                            ...
                            var n = this.getSelectedText(),
                                ...
                                o = n.replace(/([a-z]+|[A-Z]+)(?=[A-Z_]|$)/g, '$1 ').split(/\s/),
                                r = t - i - 1;
                            r < 0 && (r = 0);
                            var a = 0,
                                l = 0,
                            ...
                            for (var h, u = this.$toggleWordPairs, d = 0; d < u.length; d++)
                                for (var g = u[d], p = 0; p <= 1; p++) {
                                    var f = +!p,
                                        m = n.match(new RegExp('^\\s?_?(' + s.escapeRegExp(g[p]) + ')\\s?$', 'i'));
                                    if (m)
                                        n.match(new RegExp('([_]|^|\\s)(' + s.escapeRegExp(m[1]) + ')($|\\s)', 'g')) &&
                                            ((h = n.replace(new RegExp(s.escapeRegExp(g[p]), 'i'), function (e) {
                                                var t = g[f];
                                                return (
                                                    e.toUpperCase() == e
                                                        ? (t = t.toUpperCase())
                        ...
                        (e.prototype.findLinkAt = function (e, t) {
                            var n,
                                o,
                                r = this.session.getLine(e).split(/((?:https?|ftp):\/\/[\S]+)/),
                                s = t;
                            s < 0 && (s = 0);
                            var a,
                                l = 0,
                            ...
                            try {
                                for (var h = i(r), u = h.next(); !u.done; u = h.next()) {
                                    var d = u.value;
                                    if (
                                        ((c = l + d.length), s >= l && s <= c && d.match(/((?:https?|ftp):\/\/[\S]+)/))
                                    ) {
                                        a = d.replace(/[\s:.,'";}\]]+$/, '');
                                        break;
                                    }
                                ...
                                do {
                                    if (s.value.match(/[{}()\[\]]/g)) {
                                        for (; u < s.value.length && !c; u++)
                                            if (d[s.value[u]])
                                                switch (
                                                    ((l = d[s.value[u]] + '.' + s.type.replace('rparen', 'lparen')),
                                                    isNaN(h[l]) && (h[l] = 0),
                                                    s.value[u])
                                                ) {
                                                    case '(':
                                        ...
                                        -1 !== s.type.indexOf('tag-name') &&
                                            ...
                                            '<' === o.value && r > 1 ? h[s.value]++ : '</' === o.value && h[s.value]--,
                                ...
                                if (a) {
                                    ...
                                    if ('bracket' === a)
                                        (g = this.session.getBracketRange(n)) ||
                                            ...
                                            (t || (f.row === n.row && Math.abs(f.column - n.column) < 2)) &&
            ...
            (A.$uid = 0),
                ...
                (A.prototype.prevOp = {}),
                (A.prototype.$mergeableCommands = ['backspace', 'del', 'insertstring']),
                        ...
                        set: function (e) {
                            ...
                            e
                                ? ((this.renderer.enableKeyboardAccessibility = !0),
                                  ...
                                  this.renderer.scroller.addEventListener('keyup', i.bind(this)),
                                ...
                                : ((this.renderer.enableKeyboardAccessibility = !1),
                                  ...
                                  this.renderer.scroller.removeEventListener('keyup', i.bind(this)),
    ...
    ace.define('ace/undomanager', ['require', 'exports', 'module', 'ace/range'], function (e, t, n) {
        ...
        function o(e) {
            if (((e = e || this), Array.isArray(e))) return e.map(o).join('\n');
            var t = '';
            return (
                e.action
        ...
        function s(e, t) {
            var n = 'insert' == e.action,
                i = 'insert' == t.action;
            if (n && i)
                if (f(t.start, e.end) >= 0) c(t, e, -1);
                else {
                    if (!(f(t.start, e.start) <= 0)) return null;
                    c(e, t, 1);
                }
            else if (n && !i)
                if (f(t.start, e.end) >= 0) c(t, e, -1);
                else {
                    if (!(f(t.end, e.start) <= 0)) return null;
                    c(e, t, -1);
                }
            else if (!n && i)
                if (f(t.start, e.start) >= 0) c(t, e, 1);
                else {
                    if (!(f(t.start, e.start) <= 0)) return null;
                    c(e, t, 1);
                }
        ...
        function l(e, t) {
            var n = 'insert' == e.action,
                i = 'insert' == t.action;
            if (n && i) f(e.start, t.start) < 0 ? c(t, e, 1) : c(e, t, 1);
            else if (n && !i)
                f(e.start, t.end) >= 0
                    ? c(e, t, -1)
                    : (f(e.start, t.start) <= 0 || c(e, p.fromPoints(t.start, e.start), -1), c(t, e, 1));
            else if (!n && i)
                f(t.start, e.end) >= 0
                    ? c(t, e, -1)
                    : (f(t.start, e.start) <= 0 || c(t, p.fromPoints(e.start, t.start), -1), c(e, t, 1));
            else if (!n && !i)
                if (f(t.start, e.end) >= 0) c(t, e, -1);
                else {
                    var o, r;
                    if (!(f(t.end, e.start) <= 0))
                        return (
                            f(e.start, t.start) < 0 && ((o = e), (e = u(e, t.start))),
                            f(e.end, t.end) > 0 && (r = u(e, t.end)),
                            h(t.end, e.start, e.end, -1),
                            r && !o && ((e.lines = r.lines), (e.start = r.start), (e.end = r.end), (r = e)),
                            [t, o, r].filter(Boolean)
                        );
                    c(e, t, -1);
                }
            return [t, e];
        ...
        function c(e, t, n) {
            h(e.start, t.start, t.end, n), h(e.end, t.start, t.end, n);
        }
        function h(e, t, n, i) {
        ...
        function u(e, t) {
            ...
            var r = e.end.row - e.start.row,
                s = n.splice(r, n.length),
                a = r ? t.column : t.column - e.start.column;
            return (
                n.push(s[0].substring(0, a)),
                (s[0] = s[0].substr(a)),
                { start: i(t), end: o, lines: s, action: e.action }
            );
        }
        function d(e, t) {
            t = (function (e) {
                return { start: i(e.start), end: i(e.end), action: e.action, lines: e.lines.slice() };
            })(t);
            for (var n = e.length; n--; ) {
                for (var o = e[n], r = 0; r < o.length; r++) {
                    var s = l(o[r], t);
                    (t = s[0]),
                        2 != s.length && (s[2] ? (o.splice(r + 1, 1, s[1], s[2]), r++) : s[1] || (o.splice(r, 1), r--));
                }
                o.length || e.splice(n, 1);
            }
            return e;
        }
        var g = (function () {
            ...
            return (
                ...
                (e.prototype.add = function (e, t, n) {
                    if (!this.$fromUndo && e != this.$lastDelta) {
                        if ((this.$keepRedoStack || (this.$redoStack.length = 0), !1 === t || !this.lastDeltas)) {
                            ...
                            i > this.$undoDepth - 1 && this.$undoStack.splice(0, i - this.$undoDepth + 1),
                ...
                (e.prototype.undo = function (e, t) {
                    ...
                    if (
                        ...
                        var i = n.pop(),
                            o = null;
                        return (
                            i && ((o = e.undoChanges(i, t)), this.$redoStack.push(i), this.$syncRev()),
                            (this.$fromUndo = !1),
                            o
                        );
                    }
                ...
                (e.prototype.redo = function (e, t) {
                    if (
                        ...
                        (function (e, t) {
                            for (var n = 0; n < t.length; n++) for (var i = t[n], o = 0; o < i.length; o++) d(e, i[o]);
                        })(this.$redoStack, n),
                            (this.$redoStackBaseRev = this.$rev),
                    ...
                    var i = this.$redoStack.pop(),
                        o = null;
                    return (
                        i && ((o = e.redoChanges(i, t)), this.$undoStack.push(i), this.$syncRev()),
                        (this.$fromUndo = !1),
                        o
                    );
                }),
                ...
                (e.prototype.$prettyPrint = function (e) {
                    return e ? o(e) : o(this.$undoStack) + '\n---\n' + o(this.$redoStack);
                }),
                e
            );
        })();
        (g.prototype.hasUndo = g.prototype.canUndo),
            (g.prototype.hasRedo = g.prototype.canRedo),
            (g.prototype.isClean = g.prototype.isAtBookmark),
            (g.prototype.markClean = g.prototype.bookmark);
        var p = e('./range').Range,
            f = p.comparePoints;
        p.comparePoints;
        t.UndoManager = g;
            ...
            o = (function () {
                ...
                return (
                    ...
                    (e.prototype.computeLineTop = function (e, t, n) {
                        ...
                        return n.documentToScreenRow(e, 0) * t.lineHeight - o * this.canvasHeight;
                    }),
                    ...
                    (e.prototype.push = function (e) {
                        if (Array.isArray(e)) {
                            ...
                            for (var t = i.createFragment(this.element), n = 0; n < e.length; n++)
                    ...
                    (e.prototype.createCell = function (e, t, n, o) {
                        ...
                        if (!r) {
                            ...
                            o && o(s), this.element.appendChild(s), (r = { element: s, text: '', row: e });
                        }
                        return (r.row = e), r;
                    }),
                    e
    ...
    ace.define(
        ...
        function (e, t, n) {
                    ...
                    return (
                        ...
                        (e.prototype.setAnnotations = function (e) {
                            ...
                            for (var t = 0; t < e.length; t++) {
                                ...
                                var r = n.text,
                                    a = n.type;
                                (r = r ? s.escapeHTML(r) : n.html || ''),
                                    -1 === o.text.indexOf(r) && (o.text.push(r), o.type.push(a));
                                var l = n.className;
                                l
                                    ? (o.className = l)
                                    : 'error' == a
                                    ...
                                    : 'info' == a && !o.className && (o.className = ' ace_info');
                            }
                        }),
                        ...
                        (e.prototype.update = function (e) {
                            ...
                            var t = this.session,
                                n = e.firstRow,
                                o = Math.min(e.lastRow + e.gutterOffset, t.getLength() - 1);
                            (this.oldLastRow = o),
                                (this.config = e),
                                this.$lines.moveContainer(e),
                                this.$updateCursorRow();
                            for (
                                var r = t.getNextFoldLine(n), s = r ? r.start.row : 1 / 0, a = null, l = -1, c = n;
                                ;
                                ...
                                if (
                                    (c > s &&
                                        ((c = r.end.row + 1),
                                        (s = (r = t.getNextFoldLine(c, r)) ? r.start.row : 1 / 0)),
                                    c > o)
                                ) {
                                ...
                                (a = this.$lines.get(++l))
                                    ? (a.row = c)
                                    : ((a = this.$lines.createCell(c, e, this.session, i)), this.$lines.push(a)),
                                    this.$renderCell(a, e, r, c),
                                    c++;
                            }
                        ...
                        (e.prototype.$updateGutterWidth = function (e) {
                            ...
                            var r = n ? n.getWidth(t, o, e) : o.toString().length * e.characterWidth,
                        ...
                        (e.prototype.$renderLines = function (e, t, n) {
                            for (
                                var o = [], r = t, s = this.session.getNextFoldLine(r), a = s ? s.start.row : 1 / 0;
                                r > a &&
                                    ((r = s.end.row + 1),
                                    (a = (s = this.session.getNextFoldLine(r, s)) ? s.start.row : 1 / 0)),
                                    !(r > n);

                            ) {
                                var l = this.$lines.createCell(r, e, this.session, i);
                                this.$renderCell(l, e, s, r), o.push(l), r++;
                            }
                            return o;
                        }),
                        (e.prototype.$renderCell = function (e, t, n, i) {
                            var r = e.element,
                                ...
                                $ = (f ? f.getText(s, i) : i + d).toString();
                            if (
                                (this.$highlightGutterLine &&
                                    (i == this.$cursorRow ||
                                        (n && i < this.$cursorRow && i >= v && this.$cursorRow <= n.end.row)) &&
                                ...
                                g[i] && (y += g[i]),
                                p[i] && (y += p[i]),
                                this.$annotations[i] && i !== v && (y += this.$annotations[i].className),
                                r.className != y && (r.className = y),
                                m)
                            ) {
                                var C = m[i];
                                null == C && (C = m[i] = s.getFoldWidget(i));
                            }
                            if (C) {
                                y = 'ace_fold-widget ace_' + C;
                                if ('start' == C && i == v && i < n.end.row) {
                                    y += ' ace_closed';
                                    for (var S, x = !1, A = i + 1; A <= n.end.row; A++)
                                        if (this.$annotations[A]) {
                                            if (' ace_error' === this.$annotations[A].className) {
                                                (x = !0), (S = ' ace_error_fold');
                                                break;
                                            }
                                            ' ace_warning' !== this.$annotations[A].className ||
                                                ((x = !0), (S = ' ace_warning_fold'));
                                        }
                                    r.className += S;
                                } else y += ' ace_open';
                                l.className != y && (l.className = y),
                                    o.setStyle(l.style, 'height', w),
                                    o.setStyle(l.style, 'display', 'inline-block'),
                                    l.setAttribute('role', 'button'),
                                    l.setAttribute('tabindex', '-1'),
                                    (n = s.getFoldLine($ - 1))
                                        ? (l.setAttribute('aria-label', c('Unfold rows $0 to $1', [$, n.end.row + 1])),
                                          l.setAttribute('title', c('Unfold code')))
                                        : (l.setAttribute('aria-label', c('Fold at row $0', [$])),
                                          l.setAttribute('title', c('Fold code')));
                            } else
                                l &&
                                    (o.setStyle(l.style, 'display', 'none'),
                                    l.setAttribute('tabindex', '0'),
                                    l.removeAttribute('role'),
                                    l.removeAttribute('aria-label'));
                            return (
                                x && this.$showFoldedAnnotations
                                    ? ((h.className = 'ace_gutter_annotation'),
                                      (u.className = b),
                                      (u.className += S),
                                      o.setStyle(u.style, 'height', w),
                                      o.setStyle(h.style, 'display', 'block'),
                                      o.setStyle(h.style, 'height', w),
                                      h.setAttribute('aria-label', c('Read annotations row $0', [$])),
                                    ...
                                    ? ((h.className = 'ace_gutter_annotation'),
                                      ...
                                      this.$useSvgGutterIcons
                                          ? (u.className += this.$annotations[i].className)
                                      ...
                                      h.setAttribute('tabindex', '-1'),
                                      h.setAttribute('role', 'button'))
                                    : (o.setStyle(h.style, 'display', 'none'),
                                      h.removeAttribute('aria-label'),
                                      h.removeAttribute('role'),
                                      h.setAttribute('tabindex', '0')),
                                $ !== a.data && (a.data = $),
                                o.setStyle(e.element.style, 'height', this.$lines.computeLineHeight(i, t, s) + 'px'),
                                o.setStyle(e.element.style, 'top', this.$lines.computeLineTop(i, t, s) + 'px'),
                                (e.text = $),
                                'none' === h.style.display && 'none' === l.style.display
                        ...
                        (e.prototype.setShowFoldWidgets = function (e) {
                            e
                                ? o.addCssClass(this.element, 'ace_folding-enabled')
                                : o.removeCssClass(this.element, 'ace_folding-enabled'),
                        ...
                        (e.prototype.$computePadding = function () {
                            ...
                            var e = o.computedStyle(this.element.firstChild);
                            return (
                                (this.$padding = {}),
                                (this.$padding.left =
            ...
            (h.prototype.$fixedWidth = !1),
                (h.prototype.$highlightGutterLine = !0),
                (h.prototype.$renderer = ''),
                (h.prototype.$showLineNumbers = !0),
                (h.prototype.$showFoldWidgets = !0),
        ...
        var o = e('../range').Range,
            ...
            s = (function () {
                ...
                return (
                                    ...
                                    if (!o.isEmpty())
                                        if (((o = o.toScreenRange(this.session)), i.renderer)) {
                                            ...
                                            'fullLine' == i.type
                                                ...
                                                : this.drawSingleLineMarker(t, o, i.clazz + ' ace_start ace_br15', e);
                    ...
                    (e.prototype.drawTextMarker = function (e, t, n, r, s) {
                        for (
                            var a = this.session,
                                l = t.start.row,
                                c = t.end.row,
                                ...
                                u = 0,
                                d = 0,
                                g = a.getScreenLastRowColumn(h),
                                p = new o(h, t.start.column, h, d);
                            h <= c;
                            h++
                        )
                            (p.start.row = p.end.row = h),
                                (p.start.column = h == l ? t.start.column : a.getRowWrapIndent(h)),
                                (p.end.column = g),
                                (u = d),
                                (d = g),
                                (g = h + 1 < c ? a.getScreenLastRowColumn(h + 1) : h == c ? 0 : t.end.column),
                                this.drawSingleLineMarker(
                                    ...
                                    n +
                                        (h == l ? ' ace_start' : '') +
                                        ' ace_br' +
                                        i(h == l || (h == l + 1 && t.start.column), u < d, d > g, h == c),
                                    r,
                                    h == c ? 0 : 1,
                                    s
                                );
                    ...
                    (e.prototype.drawMultiLineMarker = function (e, t, n, i, o) {
                        ...
                        ((o = o || ''), this.session.$bidiHandler.isBidiRow(t.start.row))
                            ? (((c = t.clone()).end.row = c.start.row),
                              (c.end.column = this.session.getLine(c.start.row).length),
                              this.drawBidiSingleLineMarker(e, c, n + ' ace_br1 ace_start', i, null, o))
                            : this.elt(
                                  n + ' ace_br1 ace_start',
                                  'height:' + s + 'px;right:0;top:' + a + 'px;left:' + l + 'px;' + (o || '')
                              );
                        if (this.session.$bidiHandler.isBidiRow(t.end.row)) {
                            var c;
                            ((c = t.clone()).start.row = c.end.row),
                                (c.start.column = 0),
                                this.drawBidiSingleLineMarker(e, c, n + ' ace_br12', i, null, o);
                        } else {
                            a = this.$getTop(t.end.row, i);
                            var h = t.end.column * i.characterWidth;
                            this.elt(
                                n + ' ace_br12',
                                'height:' + s + 'px;width:' + h + 'px;top:' + a + 'px;left:' + r + 'px;' + (o || '')
                            );
                        }
                        if (!((s = (t.end.row - t.start.row - 1) * i.lineHeight) <= 0)) {
                            ...
                            this.elt(
                                n + (u ? ' ace_br' + u : ''),
                                'height:' + s + 'px;right:0;top:' + a + 'px;left:' + r + 'px;' + (o || '')
                            );
                        }
                    }),
                    ...
                    (e.prototype.drawBidiSingleLineMarker = function (e, t, n, i, o, r) {
                        var s = i.lineHeight,
                            a = this.$getTop(t.start.row, i),
                            l = this.$padding;
    ...
    ace.define(
        ...
        function (e, t, n) {
                    ...
                    return (
                            ...
                            for (var t = (this.$tabStrings = [0]), n = 1; n < e + 1; n++)
                                if (this.showTabs) {
                                    ((i = this.dom.createElement('span')).className =
                                        ...
                                        t.push(i);
                                } else t.push(this.dom.createTextNode(r.stringRepeat(' ', n), this.element));
                            if (this.displayIndentGuides) {
                                this.$indentGuideRe = /\s\S| \t|\t |\s$/;
                                var i,
                                    o = 'ace_indent-guide',
                                    s = this.showSpaces ? ' ace_invisible ace_invisible_space' : '',
                                    a = this.showSpaces
                                        ? r.stringRepeat(this.SPACE_CHAR, this.tabSize)
                                        : r.stringRepeat(' ', this.tabSize),
                                    l = this.showTabs ? ' ace_invisible ace_invisible_tab' : '',
                                    c = this.showTabs ? r.stringRepeat(this.TAB_CHAR, this.tabSize) : a;
                        ...
                        (e.prototype.updateLines = function (e, t, n) {
                            ...
                            for (
                                var l,
                                    c = !1,
                                    h = ((a = i), (l = this.session.getNextFoldLine(a)) ? l.start.row : 1 / 0);
                                a > h &&
                                    ((a = l.end.row + 1),
                                ...
                                if (u) {
                                    this.dom.removeChildren(u),
                                        ...
                                        c && (u.style.top = this.$lines.computeLineTop(a, e, this.session) + 'px');
                        ...
                        (e.prototype.$renderLinesFragment = function (e, t, n) {
                            for (
                                var i = [], r = t, s = this.session.getNextFoldLine(r), a = s ? s.start.row : 1 / 0;
                                r > a &&
                                    ((r = s.end.row + 1),
                                    (a = (s = this.session.getNextFoldLine(r, s)) ? s.start.row : 1 / 0)),
                                    !(r > n);
                                ...
                                this.dom.removeChildren(c),
                                    ...
                                    o.setStyle(c.style, 'top', this.$lines.computeLineTop(r, e, this.session) + 'px'),
                        ...
                        (e.prototype.$renderToken = function (e, t, n, i) {
                            for (
                                ...
                                if (s.showSpaces || !d) {
                                    ...
                                    if (
                                        ...
                                        m && c.appendChild(this.dom.createTextNode(m, this.element)),
                                        u)
                                    ) {
                                        var v = s.session.getScreenTabSize(t + o.index);
                                        c.appendChild(s.$tabStrings[v].cloneNode(!0)), (t += v - 1);
                                    } else if (d)
                                        if (s.showSpaces) {
                                            ((y = this.dom.createElement('span')).className =
                                                'ace_invisible ace_invisible_space'),
                                                (y.textContent = r.stringRepeat(s.SPACE_CHAR, d.length)),
                                                c.appendChild(y);
                                        } else c.appendChild(this.com.createTextNode(d, this.element));
                                    else if (g) {
                                        ((y = this.dom.createElement('span')).className =
                                            'ace_invisible ace_invisible_space ace_invalid'),
                                            (y.textContent = r.stringRepeat(s.SPACE_CHAR, g.length)),
                                            c.appendChild(y);
                                    } else if (p) {
                                        (t += 1),
                            ...
                            if (
                                (c.appendChild(this.dom.createTextNode(h ? i.slice(h) : i, this.element)),
                                ...
                                'fold' == n.type &&
                                    ((y.style.width = n.value.length * this.config.characterWidth + 'px'),
                        ...
                        (e.prototype.$renderWrappedLine = function (e, t, n) {
                            ...
                            for (var c = 0; c < t.length; c++) {
                                ...
                                if (0 == c && this.displayIndentGuides) {
                                    if (((i = u.length), !(u = this.renderIndentGuide(l, u, s)))) continue;
                                    i -= u.length;
                                }
                                if (i + u.length < s) (a = this.$renderToken(l, a, h, u)), (i += u.length);
                                else {
                                    for (; i + u.length >= s; )
                                        (a = this.$renderToken(l, a, h, u.substring(0, s - i))),
                                            ...
                                            e.appendChild(l),
                                            l.appendChild(
                                                this.dom.createTextNode(r.stringRepeat(' ', n.indent), this.element)
                                            ),
                                            (a = 0),
                                            (s = n[++o] || Number.MAX_VALUE);
                                    0 != u.length && ((i += u.length), (a = this.$renderToken(l, a, h, u)));
                                }
                            }
                        ...
                        (e.prototype.$renderLine = function (e, t, n) {
                            ...
                            if (i.length) {
                                ...
                                if (r && r.length) {
                                    ...
                                    o = e;
                                    this.$useLineGroups() && ((o = this.$createLineElement()), e.appendChild(o)),
                                        this.$renderSimpleLine(o, i);
                                }
                            } else this.$useLineGroups() && ((o = this.$createLineElement()), e.appendChild(o));
                            if (this.showEOL && o) {
                                n && (t = n.end.row);
                                            ...
                                            : (a && (o = n.getTokens(t)),
                                              o.length &&
                                                  (function (e, t, n) {
                                                      ...
                                                      for (
                                                          r != t &&
                                                          ((s = e[o].value.substring(t - r)).length > n - t &&
                                                              (s = s.substring(0, n - t)),
            ...
            (c.prototype.$textToken = { text: !0, rparen: !0, lparen: !0 }),
                (c.prototype.EOF_CHAR = '¶'),
                (c.prototype.EOL_CHAR_LF = '¬'),
                (c.prototype.EOL_CHAR_CRLF = '¤'),
                (c.prototype.EOL_CHAR = c.prototype.EOL_CHAR_LF),
                (c.prototype.TAB_CHAR = '—'),
                (c.prototype.SPACE_CHAR = '·'),
    ...
    ace.define('ace/layer/cursor', ['require', 'exports', 'module', 'ace/lib/dom'], function (e, t, n) {
                ...
                return (
                    ...
                    (e.prototype.restartTimer = function () {
                        ...
                        if (
                            ...
                            this.smoothBlinking &&
                                ((this.$isSmoothBlinking = !1), i.removeCssClass(this.element, 'ace_smooth-blinking')),
                            e(!0),
                            ...
                            if (!((s.top > e.height + e.offset || s.top < 0) && n > 1)) {
                                ...
                                this.drawCursor
                                    ...
                                    ? (i.setStyle(l, 'display', 'block'),
                                      ...
                                      i.setStyle(l, 'width', Math.round(e.characterWidth) + 'px'),
        ...
        (o.prototype.$padding = 0), (o.prototype.drawCursor = null), (t.Cursor = o);
    }),
    ace.define(
        'ace/scrollbar',
        ...
        function (e, t, n) {
            ...
            var h = (function (e) {
                function t(t, n) {
                    ...
                    return (
                        (i.scrollTop = 0),
                        (i.scrollHeight = 0),
                        (n.$scrollbarWidth = i.width = r.scrollbarWidth(t.ownerDocument)),
                        (i.inner.style.width = i.element.style.width = (i.width || 15) + 5 + 'px'),
                        (i.$minWidth = 0),
                        i
                    );
                }
                return (
                    ...
                    (t.prototype.setScrollHeight = function (e) {
                        (this.scrollHeight = e),
                            e > l ? ((this.coeff = l / e), (e = l)) : 1 != this.coeff && (this.coeff = 1),
            ...
            var u = (function (e) {
                function t(t, n) {
                    ...
                    return (
                        ...
                        (i.inner.style.height = i.element.style.height = (i.height || 15) + 5 + 'px'),
                        i
                    );
                }
                return (
            ...
            (t.ScrollBar = h), (t.ScrollBarV = h), (t.ScrollBarH = u), (t.VScrollBar = h), (t.HScrollBar = u);
        }
    ),
    ace.define(
            ...
            var c = (function (e) {
                function t(t, n) {
                    ...
                    return (
                        ...
                        (i.renderer = n),
                        (i.inner.style.width = i.element.style.width = (i.width || 15) + 'px'),
                        (i.$minWidth = 0),
                        i
                    );
                }
                return (
                    ...
                    (t.prototype.onMouseDown = function (e, t) {
                        if ('mousedown' === e && 0 === s.getButton(t) && 2 !== t.detail) {
                            ...
                            return this._emit('scroll', { data: this.scrollTopFromThumbTop(l) }), s.preventDefault(t);
                        }
                    }),
                    (t.prototype.getHeight = function () {
                        return this.height;
                    ...
                    (t.prototype.scrollTopFromThumbTop = function (e) {
                        ...
                        return (
                            (t >>= 0) < 0
                                ? (t = 0)
                                : t > this.pageHeight - this.viewHeight && (t = this.pageHeight - this.viewHeight),
                            t
                        );
                    }),
                    (t.prototype.getWidth = function () {
                    ...
                    (t.prototype.setScrollTop = function (e) {
                        (this.scrollTop = e),
                            e < 0 && (e = 0),
                            (this.thumbTop =
                                (e * (this.slideHeight - this.thumbHeight)) / (this.pageHeight - this.viewHeight)),
            ...
            var h = (function (e) {
                function t(t, n) {
                    ...
                    return (
                        ...
                        (i.inner.style.height = i.element.style.height = (i.height || 12) + 'px'),
                        (i.renderer = n),
                        i
                    );
                }
                return (
                    ...
                    (t.prototype.onMouseDown = function (e, t) {
                        if ('mousedown' === e && 0 === s.getButton(t) && 2 !== t.detail) {
                            ...
                            return this._emit('scroll', { data: this.scrollLeftFromThumbLeft(l) }), s.preventDefault(t);
                        }
                    }),
                    (t.prototype.getHeight = function () {
                        return this.isVisible ? this.height : 0;
                    ...
                    (t.prototype.scrollLeftFromThumbLeft = function (e) {
                        ...
                        return (
                            (t >>= 0) < 0
                                ? (t = 0)
                                : t > this.pageWidth - this.viewWidth && (t = this.pageWidth - this.viewWidth),
                            t
                        );
                    }),
                    (t.prototype.setWidth = function (e) {
                    ...
                    (t.prototype.setScrollLeft = function (e) {
                        (this.scrollLeft = e),
                            e < 0 && (e = 0),
                            (this.thumbLeft =
                                (e * (this.slideWidth - this.thumbWidth)) / (this.pageWidth - this.viewWidth)),
    ...
    ace.define(
        ...
        function (e, t, n) {
                ...
                d = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.$initTransformMeasureNodes = function () {
                            ...
                            this.els = o.buildDom([e(0, 0), e(u, 0), e(0, u), e(u, u)], this.el);
                        }),
            ...
            (d.prototype.$characterSize = { width: 0, height: 0 }), i.implement(d.prototype, l), (t.FontMetrics = d);
        }
    ),
                    ...
                    return (
                        (e.prototype.$updateDecorators = function (e) {
                            ...
                            if ((n.clearRect(0, 0, this.canvas.width, this.canvas.height), i)) {
                                ...
                                for (var r = this.renderer.session.$foldData, s = 0; s < i.length; s++) {
                                    var a = i[s].row,
                                        ...
                                        u = Math.round(
                                            ((a - l) * this.lineHeight + this.lineHeight) * this.heightRatio
                                        );
                                    if (u - h < this.minDecorationHeight) {
                                        var d = ((h + u) / 2) | 0;
                                        d < this.halfMinDecorationHeight
                                            ? (d = this.halfMinDecorationHeight)
                                            : d + this.halfMinDecorationHeight > this.canvasHeight &&
                                              (d = this.canvasHeight - this.halfMinDecorationHeight),
                                            (h = Math.round(d - this.halfMinDecorationHeight)),
                                            (u = Math.round(d + this.halfMinDecorationHeight));
                                    }
                                    (n.fillStyle = t[i[s].type] || null), n.fillRect(0, c, this.canvasWidth, u - h);
                                }
                            }
                            var g = this.renderer.session.selection.getCursor();
                            if (g) {
                                (l = this.compensateFoldRows(g.row, r)),
                                    (c = Math.round((g.row - l) * this.lineHeight * this.heightRatio));
                                (n.fillStyle = 'rgba(0, 0, 0, 0.5)'), n.fillRect(0, c, this.canvasWidth, 2);
                            }
                        }),
                ...
                return (
                    (e.prototype.updateCharacterSize = function () {
                        this.$textLayer.allowBoldFonts != this.$allowBoldFonts &&
                            ...
                            o.setStyle(this.scroller.style, 'line-height', this.lineHeight + 'px');
                    }),
                    (e.prototype.setSession = function (e) {
                    ...
                    (e.prototype.$updateCachedSize = function (e, t, n, i) {
                        ...
                        if (
                            ...
                            (r |= this.CHANGE_SIZE),
                                ...
                                o.setStyle(this.scroller.style, 'left', t + this.margin.left + 'px'),
                                (s.scrollerWidth = Math.max(0, n - t - this.scrollBarV.getWidth() - this.margin.h)),
                                o.setStyle(this.$gutter.style, 'left', this.margin.left + 'px');
                            var l = this.scrollBarV.getWidth() + 'px';
                            o.setStyle(this.scrollBarH.element.style, 'right', l),
                                o.setStyle(this.scroller.style, 'right', l),
                                o.setStyle(this.scroller.style, 'bottom', this.scrollBarH.getHeight()),
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var i =
                                        this.scrollTop +
                                        (n.firstRow - Math.max(this.layerConfig.firstRow, 0)) * this.lineHeight;
                                    i > 0 &&
                                        ((this.scrollTop = i),
                                        (e |= this.CHANGE_SCROLL),
                                        (e |= this.$computeLayerConfig() | this.$loop.clear()));
                                ...
                                var r = n.width + 2 * this.$padding + 'px',
                                    s = n.minHeight + 'px';
                                o.setStyle(this.content.style, 'width', r), o.setStyle(this.content.style, 'height', s);
                            }
                            return (
                                e & this.CHANGE_H_SCROLL &&
                                    (o.translate(this.content, -this.scrollLeft, -n.offset),
                    ...
                    (e.prototype.$computeLayerConfig = function () {
                        ...
                        this.session.setScrollTop(
                            ...
                            this.session.setScrollLeft(
                                Math.max(
                                    -h.left,
                                    Math.min(this.scrollLeft, o + 2 * this.$padding - t.scrollerWidth + h.right)
                                )
                            );
                        var u =
                                !n &&
                        ...
                        var $ = 0;
                        return (
                            (this.layerConfig.width != o || s) && ($ = this.CHANGE_H_SCROLL),
                            (s || d) &&
                            ...
                            (this.layerConfig = {
                                ...
                                maxHeight: i,
                                offset: f,
                                gutterOffset: y ? Math.max(0, Math.ceil((f + t.height - t.scrollerHeight) / y)) : 0,
                    ...
                    (e.prototype.scrollCursorIntoView = function (e, t, n) {
                        if (0 !== this.$size.scrollerHeight) {
                            ...
                            l + s > r
                                ? (t && l + s > r + this.lineHeight && (r -= t * this.$size.scrollerHeight),
                            ...
                            o - h < c
                                ? ((o -= h) < this.$padding + h && (o = -this.scrollMargin.left),
                                  this.session.setScrollLeft(o))
                                : ((o += h),
                                  c + this.$size.scrollerWidth < o + this.characterWidth
                                      ? this.session.setScrollLeft(
                                            Math.round(o + this.characterWidth - this.$size.scrollerWidth)
                                        )
                                      : c <= this.$padding &&
                                        ...
                                        if (!o.$stopAnimation)
                                            return o.session
                                                ? void (s.length
                                                      ...
                                                      : null != i
                                                      ? ((o.session.$scrollTop = -1),
                                                        o.session.setScrollTop(i),
                                                        (i = null))
                                                      : n())
                    ...
                    (e.prototype.pixelToScreenCoordinates = function (e, t) {
                        ...
                        return { row: s, column: a, side: r - a > 0 ? 1 : -1, offsetX: o };
                    }),
                    (e.prototype.screenToTextCoordinates = function (e, t) {
                        ...
                        return this.session.screenToDocumentPosition(a, Math.max(s, 0), o);
                    }),
                    ...
                    (e.prototype.setGhostText = function (e, t) {
                        ...
                        this.addToken(o[0], 'ghost_text', i.row, i.column),
                            (this.$ghostText = { text: e, position: { row: i.row, column: i.column } }),
                            o.length > 1 &&
                    ...
                    (e.prototype.setTheme = function (e, t) {
                        function n(n) {
                            ...
                            n.$id && (i.$themeId = n.$id),
                                o.importCssString(n.cssText, n.cssClass, i.container),
                                i.theme && o.removeCssClass(i.container, i.theme.cssClass);
                            var r = 'padding' in n ? n.padding : 'padding' in (i.theme || {}) ? 4 : i.$padding;
                            i.$padding && r != i.$padding && i.setPadding(r),
                                (i.$theme = n.cssClass),
                                (i.theme = n),
                                o.addCssClass(i.container, n.cssClass),
                                o.setCssClass(i.container, 'ace_dark', n.isDark),
                        ...
                        if (window.ResizeObserver && !this.$resizeObserver) {
                            ...
                            (this.$resizeTimer = r.delayedCall(function () {
                                ...
                                (this.$resizeObserver = new window.ResizeObserver(function (t) {
                                    ...
                                    Math.abs(e.$size.width - n) > 1 || Math.abs(e.$size.height - i) > 1
                                        ? e.$resizeTimer.delay()
    ...
    ace.define(
        ...
        function (e, t, n) {
            ...
            (function () {
                o.implement(this, s),
                    (this.$createWorkerFromOldConfig = function (t, n, o, r, s) {
                        if ((e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl), a.get('packaged') || !e.toUrl))
                            r = r || a.moduleUrl(n, 'worker');
                        else {
                        ...
                        return (
                            ...
                            this.$worker.postMessage({ init: !0, tlns: c, module: n, classname: o }),
                            this.$worker
                        );
                    }),
                ...
                if ((a && r.isMac && (c = t.button), e.editor.inMultiSelectMode && 2 == c))
                    ...
                    if (0 === c) {
                        var h,
                            ...
                            f = d.getCursor(),
                            m = e.inSelection() || (d.isEmpty() && i(p, f)),
                            v = e.x,
                            w = e.y,
                            y = u.session,
                        ...
                        if ((h && r.isMac && t.ctrlKey && u.$mouseHandler.cancelContextMenu(), 'add' == h)) {
                            ...
                            (u.inVirtualSelectionMode = !0),
                                s && ((S = null), (C = d.ranges[0] || C), u.removeSelectionMarker(C)),
                                u.once('mouseup', function () {
                                    ...
                                    S && e.isEmpty() && i(S.cursor, e.cursor)
                                        ...
                                        : (s
                                              ...
                                              : C && (u.removeSelectionMarker(C), d.addRange(C)),
                                          d.addRange(e)),
                            ...
                            g && !l
                                ? d.toSingleRange()
                                : !g && l && ((x = d.toOrientedRange()), u.addSelectionMarker(x)),
                                s ? (b = y.documentToScreenPosition(d.lead)) : d.moveToPosition(p),
                                ($ = { row: -1, column: -1 });
                            var L = k;
                            o.capture(
                                u.container,
        ...
        function (e, t, n) {
                ...
                e.$multiselectOnSessionChange ||
                    ...
                    (function (e) {
                        ...
                        c.addListener(
                            ...
                            c.addListener(n, 'keyup', t, e),
                            c.addListener(n, 'blur', t, e);
                    })(e));
            }
                        ...
                        (this.splitIntoLines = function () {
                            for (
                                ...
                                if (o === r) t.push(i.clone());
                                    ...
                                    for (t.push(new s(o, i.start.column, o, this.session.getLine(o).length)); ++o < r; )
                        ...
                        (this.rectangularRangeBlock = function (e, t, n) {
                            ...
                            if (r)
                                var a = e.column,
                                    ...
                                    c = e.offsetX,
                                    h = t.offsetX;
                            else (a = t.column), (l = e.column), (c = t.offsetX), (h = e.offsetX);
                            var u,
                                d = e.row < t.row;
                            if (d)
                                var g = e.row,
                            ...
                            a < 0 && (a = 0), g < 0 && (g = 0), g == p && (n = !0);
                            for (var f = g; f <= p; f++) {
                                var m = s.fromPoints(
                                    this.session.screenToDocumentPosition(f, a, c),
                                    this.session.screenToDocumentPosition(f, l, h)
                                );
                                if (m.isEmpty()) {
                                    if (u && i(m.end, u)) break;
                                    u = m.end;
                                }
                                (m.cursor = r ? m.start : m.end), o.push(m);
                            }
                            if ((d && o.reverse(), !n)) {
                                for (var v = o.length - 1; o[v].isEmpty() && v > 0; ) v--;
                                if (v > 0) for (var w = 0; o[w].isEmpty(); ) w++;
                                for (var y = v; y >= w; y--) o[y].isEmpty() && o.splice(y, 1);
                            }
                            return o;
                        });
                }.call(a.prototype);
            ...
            (function () {
                (this.updateSelectionMarkers = function () {
                        ...
                        if (n.multiSelect) {
                            if (t.multiSelectAction)
                                'forEach' == t.multiSelectAction
                                    ...
                                    ? (n.exitMultiSelectMode(), (i = t.exec(n, e.args || {})))
                    ...
                    (this.$checkMultiselectChange = function (e, t) {
                        if (this.inMultiSelectMode && !this.inVirtualSelectionMode) {
                            ...
                            i.row != t.row || this.session.$clipPositionToDocument(i.row, i.column).column != t.column
                    ...
                    (this.selectMoreLines = function (e, t) {
                        ...
                        if (n.isEmpty()) c = a;
                            ...
                            var l = this.session.documentToScreenPosition(i ? n.end : n.start),
                    ...
                    (this.selectMore = function (e, t, n) {
                        ...
                        if (
                            !o.isEmpty() ||
                            (((o = i.getWordRange(o.start.row, o.start.column)).cursor = -1 == e ? o.start : o.end),
                        ...
                        if (n.length && o.length != n.length - 1) {
                            ...
                            n.forEach(function (t, n) {
                                var i = t.cursor,
                                    ...
                                    c = l[n] - a;
                                o > c
                                    ? e.insert(i, h.stringRepeat(' ', o - c))
                                    : e.remove(new s(i.row, i.column, i.row, i.column - o + c)),
                            ...
                            (m = this.$reAlignText(m, g)),
                                ...
                                g || ((c.start.column = 0), (c.end.column = m[m.length - 1].length)),
                    ...
                    (this.$reAlignText = function (e, t) {
                        ...
                        return e
                            .map(function (e) {
                                ...
                                return t
                                    ? null == o
                                        ? ((o = t[1].length), (r = t[2].length), (s = t[3].length), t)
                ...
                e('./config').defineOptions(p.prototype, 'editor', {
                    enableMultiselect: {
                        set: function (e) {
                            o(this), e ? this.on('mousedown', l) : this.off('mousedown', l);
                        },
                        value: !0,
                    },
                    enableBlockSelect: {
            ...
            (this.foldingStartMarker = null),
                ...
                (this.getFoldWidget = function (e, t, n) {
                    ...
                    return this.foldingStartMarker.test(i)
                        ? 'start'
                        : 'markbeginend' == t && this.foldingStopMarker && this.foldingStopMarker.test(i)
                        ? 'end'
                        : '';
                }),
    ...
    ace.define(
        ...
        ['require', 'exports', 'module', 'ace/line_widgets', 'ace/lib/dom', 'ace/range', 'ace/config'],
        function (e, t, n) {
            'use strict';
            function i(e, t, n) {
                ...
                if (i.length) {
                    ...
                    o < 0 && (o = -o - 1),
                        o >= i.length ? (o = n > 0 ? 0 : i.length - 1) : 0 === o && n < 0 && (o = i.length - 1);
                    var r = i[o];
                    if (r && n) {
                        if (r.row === t) {
                            do {
            ...
            (t.showErrorMarker = function (e, t) {
                ...
                if (u) {
                    ...
                    (s.column = (d.pos && 'number' != typeof d.column ? d.pos.sc : d.column) || 0),
                        (s.row = d.row),
                        (h = e.renderer.$gutterLayer.$annotations[s.row]);
                } else {
                    if (c) return;
                    h = { text: [a('Looks good!')], className: 'ace_ok' };
                }
                ...
                var g = {
                    ...
                    p = g.el.appendChild(r.createElement('div')),
                    f = g.el.appendChild(r.createElement('div'));
                ...
                var v = function (e, t, n) {
                    if (0 === t && ('esc' === n || 'return' === n)) return g.destroy(), { command: 'null' };
                };
                (g.destroy = function () {
                    ...
                    e.renderer.scrollCursorIntoView(null, 0.5, { bottom: g.el.offsetHeight });
            }),
                r.importCssString(
